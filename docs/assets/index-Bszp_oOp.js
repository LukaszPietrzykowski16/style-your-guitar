...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Mi,depthTest:!1,depthWrite:!1})}function vu(){return new ei({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:sc(),fragmentShader:`
		...
		`,blending:Mi,depthTest:!1,depthWrite:!1})}function Mu(){return new ei({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:sc(),fragmentShader:`
	...
	`}function Q0(s){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Xa||l===Ya,u=l===Dr||l===Nr;if(c||u){let h=e.get(a);const d=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new xu(s)),h=c?t.fromEquirectangular(a,h):t.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),h.texture;if(h!==void 0)return h.texture;{const f=a.image;return c&&f&&f.height>0||u&&f&&i(f)?(t===null&&(t=new xu(s)),h=c?t.fromEquirectangular(a):t.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),a.addEventListener("dispose",r),h.texture):null}}}return a}function i(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function e1(s){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&wr("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function t1(s,e,t,n){const i={},r=new WeakMap;function o(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const _ in d.attributes)e.remove(d.attributes[_]);for(const _ in d.morphAttributes){const m=d.morphAttributes[_];for(let g=0,p=m.length;g<p;g++)e.remove(m[g])}d.removeEventListener("dispose",o),delete i[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(h,d){return i[d.id]===!0||(d.addEventListener("dispose",o),i[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const _ in d)e.update(d[_],s.ARRAY_BUFFER);const f=h.morphAttributes;for(const _ in f){const m=f[_];for(let g=0,p=m.length;g<p;g++)e.update(m[g],s.ARRAY_BUFFER)}}function c(h){const d=[],f=h.index,_=h.attributes.position;let m=0;if(f!==null){const y=f.array;m=f.version;for(let x=0,v=y.length;x<v;x+=3){const w=y[x+0],T=y[x+1],E=y[x+2];d.push(w,T,T,E,E,w)}}else if(_!==void 0){const y=_.array;m=_.version;for(let x=0,v=y.length/3-1;x<v;x+=3){const w=x+0,T=x+1,E=x+2;d.push(w,T,T,E,E,w)}}else return;const g=new(Xh(d)?$h:Zh)(d,1);g.version=m;const p=r.get(h);p&&e.remove(p),r.set(h,g)}function u(h){const d=r.get(h);if(d){const f=h.index;f!==null&&d.version<f.version&&c(h)}else c(h);return r.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function n1(s,e,t){let n;function i(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function l(d,f){s.drawElements(n,f,r,d*o),t.update(f,n,1)}function c(d,f,_){_!==0&&(s.drawElementsInstanced(n,f,r,d*o,_),t.update(f,n,_))}function u(d,f,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,_);let g=0;for(let p=0;p<_;p++)g+=f[p];t.update(g,n,1)}function h(d,f,_,m){if(_===0)return;const g=e.get("WEBGL_multi_draw");if(g===null)for(let p=0;p<d.length;p++)c(d[p]/o,f[p],m[p]);else{g.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,m,0,_);let p=0;for(let y=0;y<_;y++)p+=f[y];for(let y=0;y<m.length;y++)t.update(p,n,m[y])}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function i1(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case s.TRIANGLES:t.triangles+=a*(r/3);break;case s.LINES:t.lines+=a*(r/2);break;case s.LINE_STRIP:t.lines+=a*(r-1);break;case s.LINE_LOOP:t.lines+=a*r;break;case s.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function r1(s,e,t){const n=new WeakMap,i=new Qe;function r(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(a);if(d===void 0||d.count!==h){let b=function(){C.dispose(),n.delete(a),a.removeEventListener("dispose",b)};var f=b;d!==void 0&&d.texture.dispose();const _=a.morphAttributes.position!==void 0,m=a.morphAttributes.normal!==void 0,g=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],y=a.morphAttributes.normal||[],x=a.morphAttributes.color||[];let v=0;_===!0&&(v=1),m===!0&&(v=2),g===!0&&(v=3);let w=a.attributes.position.count*v,T=1;w>e.maxTextureSize&&(T=Math.ceil(w/e.maxTextureSize),w=e.maxTextureSize);const E=new Float32Array(w*T*4*h),C=new Kh(E,w,T,h);C.type=Tn,C.needsUpdate=!0;const S=v*4;for(let L=0;L<h;L++){const B=p[L],U=y[L],K=x[L],q=w*T*4*L;for(let H=0;H<B.count;H++){const W=H*S;_===!0&&(i.fromBufferAttribute(B,H),E[q+W+0]=i.x,E[q+W+1]=i.y,E[q+W+2]=i.z,E[q+W+3]=0),m===!0&&(i.fromBufferAttribute(U,H),E[q+W+4]=i.x,E[q+W+5]=i.y,E[q+W+6]=i.z,E[q+W+7]=0),g===!0&&(i.fromBufferAttribute(K,H),E[q+W+8]=i.x,E[q+W+9]=i.y,E[q+W+10]=i.z,E[q+W+11]=K.itemSize===4?i.w:1)}}d={count:h,texture:C,size:new ve(w,T)},n.set(a,d),a.addEventListener("dispose",b)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(s,"morphTexture",o.morphTexture,t);else{let _=0;for(let g=0;g<c.length;g++)_+=c[g];const m=a.morphTargetsRelative?1:1-_;l.getUniforms().setValue(s,"morphTargetBaseInfluence",m),l.getUniforms().setValue(s,"morphTargetInfluences",c)}l.getUniforms().setValue(s,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(s,"morphTargetsTextureSize",d.size)}return{update:r}}function s1(s,e,t,n){let i=new WeakMap;function r(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(i.get(h)!==c&&(e.update(h),i.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(t.update(l.instanceMatrix,s.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,s.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==c&&(d.update(),i.set(d,c))}return h}function o(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:o}}class nd extends At{constructor(e,t,n,i,r,o,a,l,c,u=Ar){if(u!==Ar&&u!==Fr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Ar&&(n=Ki),n===void 0&&u===Fr&&(n=Or),super(null,i,r,o,a,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:jt,this.minFilter=l!==void 0?l:jt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const id=new At,Su=new nd(1,1),rd=new Kh,sd=new Wp,od=new ed,Tu=[],Eu=[],bu=new Float32Array(16),Au=new Float32Array(9),wu=new Float32Array(4);function qr(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=Tu[i];if(r===void 0&&(r=new Float32Array(i),Tu[i]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,s[o].toArray(r,a)}return r}function St(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function Tt(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function Wo(s,e){let t=Eu[e];t===void 0&&(t=new Int32Array(e),Eu[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function o1(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function a1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;s.uniform2fv(this.addr,e),Tt(t,e)}}function l1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(St(t,e))return;s.uniform3fv(this.addr,e),Tt(t,e)}}function c1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;s.uniform4fv(this.addr,e),Tt(t,e)}}function u1(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),Tt(t,e)}else{if(St(t,n))return;wu.set(n),s.uniformMatrix2fv(this.addr,!1,wu),Tt(t,n)}}function h1(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),Tt(t,e)}else{if(St(t,n))return;Au.set(n),s.uniformMatrix3fv(this.addr,!1,Au),Tt(t,n)}}function d1(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),Tt(t,e)}else{if(St(t,n))return;bu.set(n),s.uniformMatrix4fv(this.addr,!1,bu),Tt(t,n)}}function f1(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function p1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;s.uniform2iv(this.addr,e),Tt(t,e)}}function m1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;s.uniform3iv(this.addr,e),Tt(t,e)}}function g1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;s.uniform4iv(this.addr,e),Tt(t,e)}}function _1(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function x1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;s.uniform2uiv(this.addr,e),Tt(t,e)}}function y1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;s.uniform3uiv(this.addr,e),Tt(t,e)}}function v1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;s.uniform4uiv(this.addr,e),Tt(t,e)}}function M1(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(Su.compareFunction=Wh,r=Su):r=id,t.setTexture2D(e||r,i)}function S1(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||sd,i)}function T1(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||od,i)}function E1(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||rd,i)}function b1(s){switch(s){case 5126:return o1;case 35664:return a1;case 35665:return l1;case 35666:return c1;case 35674:return u1;case 35675:return h1;case 35676:return d1;case 5124:case 35670:return f1;case 35667:case 35671:return p1;case 35668:case 35672:return m1;case 35669:case 35673:return g1;case 5125:return _1;case 36294:return x1;case 36295:return y1;case 36296:return v1;case 35678:case 36198:case 36298:case 36306:case 35682:return M1;case 35679:case 36299:case 36307:return S1;case 35680:case 36300:case 36308:case 36293:return T1;case 36289:case 36303:case 36311:case 36292:return E1}}function A1(s,e){s.uniform1fv(this.addr,e)}function w1(s,e){const t=qr(e,this.size,2);s.uniform2fv(this.addr,t)}function R1(s,e){const t=qr(e,this.size,3);s.uniform3fv(this.addr,t)}function C1(s,e){const t=qr(e,this.size,4);s.uniform4fv(this.addr,t)}function P1(s,e){const t=qr(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function L1(s,e){const t=qr(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function I1(s,e){const t=qr(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function D1(s,e){s.uniform1iv(this.addr,e)}function N1(s,e){s.uniform2iv(this.addr,e)}function U1(s,e){s.uniform3iv(this.addr,e)}function O1(s,e){s.uniform4iv(this.addr,e)}function F1(s,e){s.uniform1uiv(this.addr,e)}function B1(s,e){s.uniform2uiv(this.addr,e)}function k1(s,e){s.uniform3uiv(this.addr,e)}function z1(s,e){s.uniform4uiv(this.addr,e)}function H1(s,e,t){const n=this.cache,i=e.length,r=Wo(t,i);St(n,r)||(s.uniform1iv(this.addr,r),Tt(n,r));for(let o=0;o!==i;++o)t.setTexture2D(e[o]||id,r[o])}function V1(s,e,t){const n=this.cache,i=e.length,r=Wo(t,i);St(n,r)||(s.uniform1iv(this.addr,r),Tt(n,r));for(let o=0;o!==i;++o)t.setTexture3D(e[o]||sd,r[o])}function G1(s,e,t){const n=this.cache,i=e.length,r=Wo(t,i);St(n,r)||(s.uniform1iv(this.addr,r),Tt(n,r));for(let o=0;o!==i;++o)t.setTextureCube(e[o]||od,r[o])}function j1(s,e,t){const n=this.cache,i=e.length,r=Wo(t,i);St(n,r)||(s.uniform1iv(this.addr,r),Tt(n,r));for(let o=0;o!==i;++o)t.setTexture2DArray(e[o]||rd,r[o])}function W1(s){switch(s){case 5126:return A1;case 35664:return w1;case 35665:return R1;case 35666:return C1;case 35674:return P1;case 35675:return L1;case 35676:return I1;case 5124:case 35670:return D1;case 35667:case 35671:return N1;case 35668:case 35672:return U1;case 35669:case 35673:return O1;case 5125:return F1;case 36294:return B1;case 36295:return k1;case 36296:return z1;case 35678:case 36198:case 36298:case 36306:case 35682:return H1;case 35679:case 36299:case 36307:return V1;case 35680:case 36300:case 36308:case 36293:return G1;case 36289:case 36303:case 36311:case 36292:return j1}}class X1{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=b1(t.type)}}class Y1{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=W1(t.type)}}class K1{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,o=i.length;r!==o;++r){const a=i[r];a.setValue(e,t[a.id],n)}}}const Ta=/(\w+)(\])?(\[|\.)?/g;function Ru(s,e){s.seq.push(e),s.map[e.id]=e}function q1(s,e,t){const n=s.name,i=n.length;for(Ta.lastIndex=0;;){const r=Ta.exec(n),o=Ta.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===i){Ru(t,c===void 0?new X1(a,s,e):new Y1(a,s,e));break}else{let h=t.map[a];h===void 0&&(h=new K1(a),Ru(t,h)),t=h}}}class To{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=e.getActiveUniform(t,i),o=e.getUniformLocation(t,r.name);q1(r,o,this)}}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,o=t.length;r!==o;++r){const a=t[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const o=e[i];o.id in t&&n.push(o)}return n}}function Cu(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const Z1=37297;let $1=0;function J1(s,e){const t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=i;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function Q1(s){const e=Xe.getPrimaries(Xe.workingColorSpace),t=Xe.getPrimaries(s);let n;switch(e===t?n="":e===Lo&&t===Po?n="LinearDisplayP3ToLinearSRGB":e===Po&&t===Lo&&(n="LinearSRGBToLinearDisplayP3"),s){case It:case Go:return[n,"LinearTransferOETF"];case Ht:case Ql:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",s),[n,"LinearTransferOETF"]}}function Pu(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),i=s.getShaderInfoLog(e).trim();if(n&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const o=parseInt(r[1]);return t.toUpperCase()+`

`+i+`

`+J1(s.getShaderSource(e),o)}else return i}function e_(s,e){const t=Q1(e);return`vec4 ${s}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function t_(s,e){let t;switch(e){case np:t="Linear";break;case ip:t="Reinhard";break;case rp:t="OptimizedCineon";break;case sp:t="ACESFilmic";break;case ap:t="AgX";break;case lp:t="Neutral";break;case op:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const oo=new D;function n_(){Xe.getLuminanceCoefficients(oo);const s=oo.x.toFixed(4),e=oo.y.toFixed(4),t=oo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function i_(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ds).join(`
`)}function r_(s){const e=[];for(const t in s){const n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function s_(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),o=r.name;let a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:s.getAttribLocation(e,o),locationSize:a}}return t}function ds(s){return s!==""}function Lu(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Iu(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const o_=/^[ \t]*#include +<([\w\d./]+)>/gm;function Sl(s){return s.replace(o_,l_)}const a_=new Map;function l_(s,e){let t=Fe[e];if(t===void 0){const n=a_.get(e);if(n!==void 0)t=Fe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Sl(t)}const c_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Du(s){return s.replace(c_,u_)}function u_(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function Nu(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function h_(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Ih?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Rf?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Xn&&(e="SHADOWMAP_TYPE_VSM"),e}function d_(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Dr:case Nr:e="ENVMAP_TYPE_CUBE";break;case Vo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function f_(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Nr:e="ENVMAP_MODE_REFRACTION";break}return e}function p_(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case jl:e="ENVMAP_BLENDING_MULTIPLY";break;case ep:e="ENVMAP_BLENDING_MIX";break;case tp:e="ENVMAP_BLENDING_ADD";break}return e}function m_(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function g_(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=h_(t),c=d_(t),u=f_(t),h=p_(t),d=m_(t),f=i_(t),_=r_(r),m=i.createProgram();let g,p,y=t.glslVersion?"#version "+t.glslVersion+`
...
Program Info Log: `+B+`
`+W+`
`+G)}else B!==""?console.warn("THREE.WebGLProgram: Program Info Log:",B):(U===""||K==="")&&(H=!1);H&&(L.diagnostics={runnable:q,programLog:B,vertexShader:{log:U,prefix:g},fragmentShader:{log:K,prefix:p}})}i.deleteShader(w),i.deleteShader(T),C=new To(i,m),S=s_(i,m)}let C;this.getUniforms=function(){return C===void 0&&E(this),C};let S;this.getAttributes=function(){return S===void 0&&E(this),S};let b=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return b===!1&&(b=i.getProgramParameter(m,Z1)),b},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(m),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=$1++,this.cacheKey=e,this.usedTimes=1,this.program=m,this.vertexShader=w,this.fragmentShader=T,this}let __=0;class x_{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),r=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(i)===!1&&(o.add(i),i.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new y_(e),t.set(e,n)),n}}class y_{constructor(e){this.id=__++,this.code=e,this.usedTimes=0}}function v_(s,e,t,n,i,r,o){const a=new nc,l=new x_,c=new Set,u=[],h=i.logarithmicDepthBuffer,d=i.vertexTextures;let f=i.precision;const _={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function m(S){return c.add(S),S===0?"uv":`uv${S}`}function g(S,b,L,B,U){const K=B.fog,q=U.geometry,H=S.isMeshStandardMaterial?B.environment:null,W=(S.isMeshStandardMaterial?t:e).get(S.envMap||H),G=W&&W.mapping===Vo?W.image.height:null,ne=_[S.type];S.precision!==null&&(f=i.getMaxPrecision(S.precision),f!==S.precision&&console.warn("THREE.WebGLProgram.getParameters:",S.precision,"not supported, using",f,"instead."));const re=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,ae=re!==void 0?re.length:0;let Me=0;q.morphAttributes.position!==void 0&&(Me=1),q.morphAttributes.normal!==void 0&&(Me=2),q.morphAttributes.color!==void 0&&(Me=3);let ke,X,$,fe;if(ne){const je=Rn[ne];ke=je.vertexShader,X=je.fragmentShader}else ke=S.vertexShader,X=S.fragmentShader,l.update(S),$=l.getVertexShaderID(S),fe=l.getFragmentShaderID(S);const he=s.getRenderTarget(),Ie=U.isInstancedMesh===!0,Oe=U.isBatchedMesh===!0,ze=!!S.map,nt=!!S.matcap,I=!!W,ct=!!S.aoMap,We=!!S.lightMap,Ye=!!S.bumpMap,ge=!!S.normalMap,ut=!!S.displacementMap,Ce=!!S.emissiveMap,Le=!!S.metalnessMap,P=!!S.roughnessMap,A=S.anisotropy>0,j=S.clearcoat>0,J=S.dispersion>0,ee=S.iridescence>0,Z=S.sheen>0,ye=S.transmission>0,se=A&&!!S.anisotropyMap,ce=j&&!!S.clearcoatMap,De=j&&!!S.clearcoatNormalMap,te=j&&!!S.clearcoatRoughnessMap,ue=ee&&!!S.iridescenceMap,Ve=ee&&!!S.iridescenceThicknessMap,Ee=Z&&!!S.sheenColorMap,de=Z&&!!S.sheenRoughnessMap,Ae=!!S.specularMap,Pe=!!S.specularColorMap,rt=!!S.specularIntensityMap,M=ye&&!!S.transmissionMap,F=ye&&!!S.thicknessMap,k=!!S.gradientMap,Y=!!S.alphaMap,Q=S.alphaTest>0,_e=!!S.alphaHash,we=!!S.extensions;let pt=Si;S.toneMapped&&(he===null||he.isXRRenderTarget===!0)&&(pt=s.toneMapping);const vt={shaderID:ne,shaderType:S.type,shaderName:S.name,vertexShader:ke,fragmentShader:X,defines:S.defines,customVertexShaderID:$,customFragmentShaderID:fe,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:f,batching:Oe,batchingColor:Oe&&U._colorsTexture!==null,instancing:Ie,instancingColor:Ie&&U.instanceColor!==null,instancingMorph:Ie&&U.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:he===null?s.outputColorSpace:he.isXRRenderTarget===!0?he.texture.colorSpace:It,alphaToCoverage:!!S.alphaToCoverage,map:ze,matcap:nt,envMap:I,envMapMode:I&&W.mapping,envMapCubeUVHeight:G,aoMap:ct,lightMap:We,bumpMap:Ye,normalMap:ge,displacementMap:d&&ut,emissiveMap:Ce,normalMapObjectSpace:ge&&S.normalMapType===pp,normalMapTangentSpace:ge&&S.normalMapType===Jl,metalnessMap:Le,roughnessMap:P,anisotropy:A,anisotropyMap:se,clearcoat:j,clearcoatMap:ce,clearcoatNormalMap:De,clearcoatRoughnessMap:te,dispersion:J,iridescence:ee,iridescenceMap:ue,iridescenceThicknessMap:Ve,sheen:Z,sheenColorMap:Ee,sheenRoughnessMap:de,specularMap:Ae,specularColorMap:Pe,specularIntensityMap:rt,transmission:ye,transmissionMap:M,thicknessMap:F,gradientMap:k,opaque:S.transparent===!1&&S.blending===br&&S.alphaToCoverage===!1,alphaMap:Y,alphaTest:Q,alphaHash:_e,combine:S.combine,mapUv:ze&&m(S.map.channel),aoMapUv:ct&&m(S.aoMap.channel),lightMapUv:We&&m(S.lightMap.channel),bumpMapUv:Ye&&m(S.bumpMap.channel),normalMapUv:ge&&m(S.normalMap.channel),displacementMapUv:ut&&m(S.displacementMap.channel),emissiveMapUv:Ce&&m(S.emissiveMap.channel),metalnessMapUv:Le&&m(S.metalnessMap.channel),roughnessMapUv:P&&m(S.roughnessMap.channel),anisotropyMapUv:se&&m(S.anisotropyMap.channel),clearcoatMapUv:ce&&m(S.clearcoatMap.channel),clearcoatNormalMapUv:De&&m(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:te&&m(S.clearcoatRoughnessMap.channel),iridescenceMapUv:ue&&m(S.iridescenceMap.channel),iridescenceThicknessMapUv:Ve&&m(S.iridescenceThicknessMap.channel),sheenColorMapUv:Ee&&m(S.sheenColorMap.channel),sheenRoughnessMapUv:de&&m(S.sheenRoughnessMap.channel),specularMapUv:Ae&&m(S.specularMap.channel),specularColorMapUv:Pe&&m(S.specularColorMap.channel),specularIntensityMapUv:rt&&m(S.specularIntensityMap.channel),transmissionMapUv:M&&m(S.transmissionMap.channel),thicknessMapUv:F&&m(S.thicknessMap.channel),alphaMapUv:Y&&m(S.alphaMap.channel),vertexTangents:!!q.attributes.tangent&&(ge||A),vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,pointsUvs:U.isPoints===!0&&!!q.attributes.uv&&(ze||Y),fog:!!K,useFog:S.fog===!0,fogExp2:!!K&&K.isFogExp2,flatShading:S.flatShading===!0,sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:h,skinning:U.isSkinnedMesh===!0,morphTargets:q.morphAttributes.position!==void 0,morphNormals:q.morphAttributes.normal!==void 0,morphColors:q.morphAttributes.color!==void 0,morphTargetsCount:ae,morphTextureStride:Me,numDirLights:b.directional.length,numPointLights:b.point.length,numSpotLights:b.spot.length,numSpotLightMaps:b.spotLightMap.length,numRectAreaLights:b.rectArea.length,numHemiLights:b.hemi.length,numDirLightShadows:b.directionalShadowMap.length,numPointLightShadows:b.pointShadowMap.length,numSpotLightShadows:b.spotShadowMap.length,numSpotLightShadowsWithMaps:b.numSpotLightShadowsWithMaps,numLightProbes:b.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:S.dithering,shadowMapEnabled:s.shadowMap.enabled&&L.length>0,shadowMapType:s.shadowMap.type,toneMapping:pt,decodeVideoTexture:ze&&S.map.isVideoTexture===!0&&Xe.getTransfer(S.map.colorSpace)===it,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===Cn,flipSided:S.side===Wt,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:we&&S.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(we&&S.extensions.multiDraw===!0||Oe)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return vt.vertexUv1s=c.has(1),vt.vertexUv2s=c.has(2),vt.vertexUv3s=c.has(3),c.clear(),vt}function p(S){const b=[];if(S.shaderID?b.push(S.shaderID):(b.push(S.customVertexShaderID),b.push(S.customFragmentShaderID)),S.defines!==void 0)for(const L in S.defines)b.push(L),b.push(S.defines[L]);return S.isRawShaderMaterial===!1&&(y(b,S),x(b,S),b.push(s.outputColorSpace)),b.push(S.customProgramCacheKey),b.join()}function y(S,b){S.push(b.precision),S.push(b.outputColorSpace),S.push(b.envMapMode),S.push(b.envMapCubeUVHeight),S.push(b.mapUv),S.push(b.alphaMapUv),S.push(b.lightMapUv),S.push(b.aoMapUv),S.push(b.bumpMapUv),S.push(b.normalMapUv),S.push(b.displacementMapUv),S.push(b.emissiveMapUv),S.push(b.metalnessMapUv),S.push(b.roughnessMapUv),S.push(b.anisotropyMapUv),S.push(b.clearcoatMapUv),S.push(b.clearcoatNormalMapUv),S.push(b.clearcoatRoughnessMapUv),S.push(b.iridescenceMapUv),S.push(b.iridescenceThicknessMapUv),S.push(b.sheenColorMapUv),S.push(b.sheenRoughnessMapUv),S.push(b.specularMapUv),S.push(b.specularColorMapUv),S.push(b.specularIntensityMapUv),S.push(b.transmissionMapUv),S.push(b.thicknessMapUv),S.push(b.combine),S.push(b.fogExp2),S.push(b.sizeAttenuation),S.push(b.morphTargetsCount),S.push(b.morphAttributeCount),S.push(b.numDirLights),S.push(b.numPointLights),S.push(b.numSpotLights),S.push(b.numSpotLightMaps),S.push(b.numHemiLights),S.push(b.numRectAreaLights),S.push(b.numDirLightShadows),S.push(b.numPointLightShadows),S.push(b.numSpotLightShadows),S.push(b.numSpotLightShadowsWithMaps),S.push(b.numLightProbes),S.push(b.shadowMapType),S.push(b.toneMapping),S.push(b.numClippingPlanes),S.push(b.numClipIntersection),S.push(b.depthPacking)}function x(S,b){a.disableAll(),b.supportsVertexTextures&&a.enable(0),b.instancing&&a.enable(1),b.instancingColor&&a.enable(2),b.instancingMorph&&a.enable(3),b.matcap&&a.enable(4),b.envMap&&a.enable(5),b.normalMapObjectSpace&&a.enable(6),b.normalMapTangentSpace&&a.enable(7),b.clearcoat&&a.enable(8),b.iridescence&&a.enable(9),b.alphaTest&&a.enable(10),b.vertexColors&&a.enable(11),b.vertexAlphas&&a.enable(12),b.vertexUv1s&&a.enable(13),b.vertexUv2s&&a.enable(14),b.vertexUv3s&&a.enable(15),b.vertexTangents&&a.enable(16),b.anisotropy&&a.enable(17),b.alphaHash&&a.enable(18),b.batching&&a.enable(19),b.dispersion&&a.enable(20),b.batchingColor&&a.enable(21),S.push(a.mask),a.disableAll(),b.fog&&a.enable(0),b.useFog&&a.enable(1),b.flatShading&&a.enable(2),b.logarithmicDepthBuffer&&a.enable(3),b.skinning&&a.enable(4),b.morphTargets&&a.enable(5),b.morphNormals&&a.enable(6),b.morphColors&&a.enable(7),b.premultipliedAlpha&&a.enable(8),b.shadowMapEnabled&&a.enable(9),b.doubleSided&&a.enable(10),b.flipSided&&a.enable(11),b.useDepthPacking&&a.enable(12),b.dithering&&a.enable(13),b.transmission&&a.enable(14),b.sheen&&a.enable(15),b.opaque&&a.enable(16),b.pointsUvs&&a.enable(17),b.decodeVideoTexture&&a.enable(18),b.alphaToCoverage&&a.enable(19),S.push(a.mask)}function v(S){const b=_[S.type];let L;if(b){const B=Rn[b];L=im.clone(B.uniforms)}else L=S.uniforms;return L}function w(S,b){let L;for(let B=0,U=u.length;B<U;B++){const K=u[B];if(K.cacheKey===b){L=K,++L.usedTimes;break}}return L===void 0&&(L=new g_(s,b,S,r),u.push(L)),L}function T(S){if(--S.usedTimes===0){const b=u.indexOf(S);u[b]=u[u.length-1],u.pop(),S.destroy()}}function E(S){l.remove(S)}function C(){l.dispose()}return{getParameters:g,getProgramCacheKey:p,getUniforms:v,acquireProgram:w,releaseProgram:T,releaseShaderCache:E,programs:u,dispose:C}}function M_(){let s=new WeakMap;function e(r){let o=s.get(r);return o===void 0&&(o={},s.set(r,o)),o}function t(r){s.delete(r)}function n(r,o,a){s.get(r)[o]=a}function i(){s=new WeakMap}return{get:e,remove:t,update:n,dispose:i}}function S_(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.material.id!==e.material.id?s.material.id-e.material.id:s.z!==e.z?s.z-e.z:s.id-e.id}function Uu(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.z!==e.z?e.z-s.z:s.id-e.id}function Ou(){const s=[];let e=0;const t=[],n=[],i=[];function r(){e=0,t.length=0,n.length=0,i.length=0}function o(h,d,f,_,m,g){let p=s[e];return p===void 0?(p={id:h.id,object:h,geometry:d,material:f,groupOrder:_,renderOrder:h.renderOrder,z:m,group:g},s[e]=p):(p.id=h.id,p.object=h,p.geometry=d,p.material=f,p.groupOrder=_,p.renderOrder=h.renderOrder,p.z=m,p.group=g),e++,p}function a(h,d,f,_,m,g){const p=o(h,d,f,_,m,g);f.transmission>0?n.push(p):f.transparent===!0?i.push(p):t.push(p)}function l(h,d,f,_,m,g){const p=o(h,d,f,_,m,g);f.transmission>0?n.unshift(p):f.transparent===!0?i.unshift(p):t.unshift(p)}function c(h,d){t.length>1&&t.sort(h||S_),n.length>1&&n.sort(d||Uu),i.length>1&&i.sort(d||Uu)}function u(){for(let h=e,d=s.length;h<d;h++){const f=s[h];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:t,transmissive:n,transparent:i,init:r,push:a,unshift:l,finish:u,sort:c}}function T_(){let s=new WeakMap;function e(n,i){const r=s.get(n);let o;return r===void 0?(o=new Ou,s.set(n,[o])):i>=r.length?(o=new Ou,r.push(o)):o=r[i],o}function t(){s=new WeakMap}return{get:e,dispose:t}}function E_(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new D,color:new Te};break;case"SpotLight":t={position:new D,direction:new D,color:new Te,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new D,color:new Te,distance:0,decay:0};break;case"HemisphereLight":t={direction:new D,skyColor:new Te,groundColor:new Te};break;case"RectAreaLight":t={color:new Te,position:new D,halfWidth:new D,halfHeight:new D};break}return s[e.id]=t,t}}}function b_(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ve};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ve};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ve,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[e.id]=t,t}}}let A_=0;function w_(s,e){return(e.castShadow?2:0)-(s.castShadow?2:0)+(e.map?1:0)-(s.map?1:0)}function R_(s){const e=new E_,t=b_(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new D);const i=new D,r=new Ne,o=new Ne;function a(c){let u=0,h=0,d=0;for(let S=0;S<9;S++)n.probe[S].set(0,0,0);let f=0,_=0,m=0,g=0,p=0,y=0,x=0,v=0,w=0,T=0,E=0;c.sort(w_);for(let S=0,b=c.length;S<b;S++){const L=c[S],B=L.color,U=L.intensity,K=L.distance,q=L.shadow&&L.shadow.map?L.shadow.map.texture:null;if(L.isAmbientLight)u+=B.r*U,h+=B.g*U,d+=B.b*U;else if(L.isLightProbe){for(let H=0;H<9;H++)n.probe[H].addScaledVector(L.sh.coefficients[H],U);E++}else if(L.isDirectionalLight){const H=e.get(L);if(H.color.copy(L.color).multiplyScalar(L.intensity),L.castShadow){const W=L.shadow,G=t.get(L);G.shadowIntensity=W.intensity,G.shadowBias=W.bias,G.shadowNormalBias=W.normalBias,G.shadowRadius=W.radius,G.shadowMapSize=W.mapSize,n.directionalShadow[f]=G,n.directionalShadowMap[f]=q,n.directionalShadowMatrix[f]=L.shadow.matrix,y++}n.directional[f]=H,f++}else if(L.isSpotLight){const H=e.get(L);H.position.setFromMatrixPosition(L.matrixWorld),H.color.copy(B).multiplyScalar(U),H.distance=K,H.coneCos=Math.cos(L.angle),H.penumbraCos=Math.cos(L.angle*(1-L.penumbra)),H.decay=L.decay,n.spot[m]=H;const W=L.shadow;if(L.map&&(n.spotLightMap[w]=L.map,w++,W.updateMatrices(L),L.castShadow&&T++),n.spotLightMatrix[m]=W.matrix,L.castShadow){const G=t.get(L);G.shadowIntensity=W.intensity,G.shadowBias=W.bias,G.shadowNormalBias=W.normalBias,G.shadowRadius=W.radius,G.shadowMapSize=W.mapSize,n.spotShadow[m]=G,n.spotShadowMap[m]=q,v++}m++}else if(L.isRectAreaLight){const H=e.get(L);H.color.copy(B).multiplyScalar(U),H.halfWidth.set(L.width*.5,0,0),H.halfHeight.set(0,L.height*.5,0),n.rectArea[g]=H,g++}else if(L.isPointLight){const H=e.get(L);if(H.color.copy(L.color).multiplyScalar(L.intensity),H.distance=L.distance,H.decay=L.decay,L.castShadow){const W=L.shadow,G=t.get(L);G.shadowIntensity=W.intensity,G.shadowBias=W.bias,G.shadowNormalBias=W.normalBias,G.shadowRadius=W.radius,G.shadowMapSize=W.mapSize,G.shadowCameraNear=W.camera.near,G.shadowCameraFar=W.camera.far,n.pointShadow[_]=G,n.pointShadowMap[_]=q,n.pointShadowMatrix[_]=L.shadow.matrix,x++}n.point[_]=H,_++}else if(L.isHemisphereLight){const H=e.get(L);H.skyColor.copy(L.color).multiplyScalar(U),H.groundColor.copy(L.groundColor).multiplyScalar(U),n.hemi[p]=H,p++}}g>0&&(s.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=oe.LTC_FLOAT_1,n.rectAreaLTC2=oe.LTC_FLOAT_2):(n.rectAreaLTC1=oe.LTC_HALF_1,n.rectAreaLTC2=oe.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=h,n.ambient[2]=d;const C=n.hash;(C.directionalLength!==f||C.pointLength!==_||C.spotLength!==m||C.rectAreaLength!==g||C.hemiLength!==p||C.numDirectionalShadows!==y||C.numPointShadows!==x||C.numSpotShadows!==v||C.numSpotMaps!==w||C.numLightProbes!==E)&&(n.directional.length=f,n.spot.length=m,n.rectArea.length=g,n.point.length=_,n.hemi.length=p,n.directionalShadow.length=y,n.directionalShadowMap.length=y,n.pointShadow.length=x,n.pointShadowMap.length=x,n.spotShadow.length=v,n.spotShadowMap.length=v,n.directionalShadowMatrix.length=y,n.pointShadowMatrix.length=x,n.spotLightMatrix.length=v+w-T,n.spotLightMap.length=w,n.numSpotLightShadowsWithMaps=T,n.numLightProbes=E,C.directionalLength=f,C.pointLength=_,C.spotLength=m,C.rectAreaLength=g,C.hemiLength=p,C.numDirectionalShadows=y,C.numPointShadows=x,C.numSpotShadows=v,C.numSpotMaps=w,C.numLightProbes=E,n.version=A_++)}function l(c,u){let h=0,d=0,f=0,_=0,m=0;const g=u.matrixWorldInverse;for(let p=0,y=c.length;p<y;p++){const x=c[p];if(x.isDirectionalLight){const v=n.directional[h];v.direction.setFromMatrixPosition(x.matrixWorld),i.setFromMatrixPosition(x.target.matrixWorld),v.direction.sub(i),v.direction.transformDirection(g),h++}else if(x.isSpotLight){const v=n.spot[f];v.position.setFromMatrixPosition(x.matrixWorld),v.position.applyMatrix4(g),v.direction.setFromMatrixPosition(x.matrixWorld),i.setFromMatrixPosition(x.target.matrixWorld),v.direction.sub(i),v.direction.transformDirection(g),f++}else if(x.isRectAreaLight){const v=n.rectArea[_];v.position.setFromMatrixPosition(x.matrixWorld),v.position.applyMatrix4(g),o.identity(),r.copy(x.matrixWorld),r.premultiply(g),o.extractRotation(r),v.halfWidth.set(x.width*.5,0,0),v.halfHeight.set(0,x.height*.5,0),v.halfWidth.applyMatrix4(o),v.halfHeight.applyMatrix4(o),_++}else if(x.isPointLight){const v=n.point[d];v.position.setFromMatrixPosition(x.matrixWorld),v.position.applyMatrix4(g),d++}else if(x.isHemisphereLight){const v=n.hemi[m];v.direction.setFromMatrixPosition(x.matrixWorld),v.direction.transformDirection(g),m++}}}return{setup:a,setupView:l,state:n}}function Fu(s){const e=new R_(s),t=[],n=[];function i(u){c.camera=u,t.length=0,n.length=0}function r(u){t.push(u)}function o(u){n.push(u)}function a(){e.setup(t)}function l(u){e.setupView(t,u)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:i,state:c,setupLights:a,setupLightsView:l,pushLight:r,pushShadow:o}}function C_(s){let e=new WeakMap;function t(i,r=0){const o=e.get(i);let a;return o===void 0?(a=new Fu(s),e.set(i,[a])):r>=o.length?(a=new Fu(s),o.push(a)):a=o[r],a}function n(){e=new WeakMap}return{get:t,dispose:n}}class P_ extends bn{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=dp,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class L_ extends bn{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const I_=`void main() {
	gl_Position = vec4( position, 1.0 );
...
`:this.appereanceControl.innerHTML=`
       ...
       `}generateStickerControlMenu(){this.isStickerControlMenuGenerated=!0,this.showStickerControlMenuAnimation(),this.stickerControl.innerHTML=`
       <span
...
*/var an={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},Gr={duration:.5,overwrite:!1,delay:0},_c,Ft,st,mn=1e8,tt=1/mn,Rl=Math.PI*2,Cy=Rl/4,Py=0,yd=Math.sqrt,Ly=Math.cos,Iy=Math.sin,wt=function(e){return typeof e=="string"},ft=function(e){return typeof e=="function"},ti=function(e){return typeof e=="number"},xc=function(e){return typeof e>"u"},Un=function(e){return typeof e=="object"},Yt=function(e){return e!==!1},yc=function(){return typeof window<"u"},go=function(e){return ft(e)||wt(e)},vd=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},Bt=Array.isArray,Cl=/(?:-?\.?\d|\.)+/gi,Md=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,Tr=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Na=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Sd=/[+-]=-?[.\d]+/,Td=/[^,'"\[\]\s]+/gi,Dy=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,at,wn,Pl,vc,ln={},Uo={},Ed,bd=function(e){return(Uo=Zi(e,ln))&&$t},Mc=function(e,t){return console.warn("Invalid property",e,"set to",t,"Missing plugin? gsap.registerPlugin()")},bs=function(e,t){return!t&&console.warn(e)},Ad=function(e,t){return e&&(ln[e]=t)&&Uo&&(Uo[e]=t)||ln},As=function(){return 0},Ny={suppressEvents:!0,isStart:!0,kill:!1},Eo={suppressEvents:!0,kill:!1},Uy={suppressEvents:!0},Sc={},Ti=[],Ll={},wd,nn={},Ua={},gh=30,bo=[],Tc="",Ec=function(e){var t=e[0],n,i;if(Un(t)||ft(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(i=bo.length;i--&&!bo[i].targetTest(t););n=bo[i]}for(i=e.length;i--;)e[i]&&(e[i]._gsap||(e[i]._gsap=new $d(e[i],n)))||e.splice(i,1);return e},ji=function(e){return e._gsap||Ec(gn(e))[0]._gsap},Rd=function(e,t,n){return(n=e[t])&&ft(n)?e[t]():xc(n)&&e.getAttribute&&e.getAttribute(t)||n},Kt=function(e,t){return(e=e.split(",")).forEach(t)||e},mt=function(e){return Math.round(e*1e5)/1e5||0},bt=function(e){return Math.round(e*1e7)/1e7||0},Pr=function(e,t){var n=t.charAt(0),i=parseFloat(t.substr(2));return e=parseFloat(e),n==="+"?e+i:n==="-"?e-i:n==="*"?e*i:e/i},Oy=function(e,t){for(var n=t.length,i=0;e.indexOf(t[i])<0&&++i<n;);return i<n},Oo=function(){var e=Ti.length,t=Ti.slice(0),n,i;for(Ll={},Ti.length=0,n=0;n<e;n++)i=t[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},Cd=function(e,t,n,i){Ti.length&&!Ft&&Oo(),e.render(t,n,Ft&&t<0&&(e._initted||e._startAt)),Ti.length&&!Ft&&Oo()},Pd=function(e){var t=parseFloat(e);return(t||t===0)&&(e+"").match(Td).length<2?t:wt(e)?e.trim():e},Ld=function(e){return e},_n=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},Fy=function(e){return function(t,n){for(var i in n)i in t||i==="duration"&&e||i==="ease"||(t[i]=n[i])}},Zi=function(e,t){for(var n in t)e[n]=t[n];return e},_h=function s(e,t){for(var n in t)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(e[n]=Un(t[n])?s(e[n]||(e[n]={}),t[n]):t[n]);return e},Fo=function(e,t){var n={},i;for(i in e)i in t||(n[i]=e[i]);return n},xs=function(e){var t=e.parent||at,n=e.keyframes?Fy(Bt(e.keyframes)):_n;if(Yt(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},By=function(e,t){for(var n=e.length,i=n===t.length;i&&n--&&e[n]===t[n];);return n<0},Id=function(e,t,n,i,r){var o=e[i],a;if(r)for(a=t[r];o&&o[r]>a;)o=o._prev;return o?(t._next=o._next,o._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[i]=t,t._prev=o,t.parent=t._dp=e,t},Xo=function(e,t,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var r=t._prev,o=t._next;r?r._next=o:e[n]===t&&(e[n]=o),o?o._prev=r:e[i]===t&&(e[i]=r),t._next=t._prev=t.parent=null},bi=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},Wi=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},ky=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},Il=function(e,t,n,i){return e._startAt&&(Ft?e._startAt.revert(Eo):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,i))},zy=function s(e){return!e||e._ts&&s(e.parent)},xh=function(e){return e._repeat?jr(e._tTime,e=e.duration()+e._rDelay)*e:0},jr=function(e,t){var n=Math.floor(e/=t);return e&&n===e?n-1:n},Bo=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},Yo=function(e){return e._end=bt(e._start+(e._tDur/Math.abs(e._ts||e._rts||tt)||0))},Ko=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=bt(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),Yo(e),n._dirty||Wi(n,e)),e},Dd=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=Bo(e.rawTime(),t),(!t._dur||Fs(0,t.totalDuration(),n)-t._tTime>tt)&&t.render(n,!0)),Wi(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-tt}},Ln=function(e,t,n,i){return t.parent&&bi(t),t._start=bt((ti(n)?n:n||e!==at?dn(e,n,t):e._time)+t._delay),t._end=bt(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),Id(e,t,"_first","_last",e._sort?"_start":0),Dl(t)||(e._recent=t),i||Dd(e,t),e._ts<0&&Ko(e,e._tTime),e},Nd=function(e,t){return(ln.ScrollTrigger||Mc("scrollTrigger",t))&&ln.ScrollTrigger.create(t,e)},Ud=function(e,t,n,i,r){if(Ac(e,t,r),!e._initted)return 1;if(!n&&e._pt&&!Ft&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&wd!==sn.frame)return Ti.push(e),e._lazy=[r,i],1},Hy=function s(e){var t=e.parent;return t&&t._ts&&t._initted&&!t._lock&&(t.rawTime()<0||s(t))},Dl=function(e){var t=e.data;return t==="isFromStart"||t==="isStart"},Vy=function(e,t,n,i){var r=e.ratio,o=t<0||!t&&(!e._start&&Hy(e)&&!(!e._initted&&Dl(e))||(e._ts<0||e._dp._ts<0)&&!Dl(e))?0:1,a=e._rDelay,l=0,c,u,h;if(a&&e._repeat&&(l=Fs(0,e._tDur,t),u=jr(l,a),e._yoyo&&u&1&&(o=1-o),u!==jr(e._tTime,a)&&(r=1-o,e.vars.repeatRefresh&&e._initted&&e.invalidate())),o!==r||Ft||i||e._zTime===tt||!t&&e._zTime){if(!e._initted&&Ud(e,t,i,n,l))return;for(h=e._zTime,e._zTime=t||(n?tt:0),n||(n=t&&!h),e.ratio=o,e._from&&(o=1-o),e._time=0,e._tTime=l,c=e._pt;c;)c.r(o,c.d),c=c._next;t<0&&Il(e,t,n,!0),e._onUpdate&&!n&&on(e,"onUpdate"),l&&e._repeat&&!n&&e.parent&&on(e,"onRepeat"),(t>=e._tDur||t<0)&&e.ratio===o&&(o&&bi(e,1),!n&&!Ft&&(on(e,o?"onComplete":"onReverseComplete",!0),e._prom&&e._prom()))}else e._zTime||(e._zTime=t)},Gy=function(e,t,n){var i;if(n>t)for(i=e._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>t)return i;i=i._next}else for(i=e._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<t)return i;i=i._prev}},Wr=function(e,t,n,i){var r=e._repeat,o=bt(t)||0,a=e._tTime/e._tDur;return a&&!i&&(e._time*=o/e._dur),e._dur=o,e._tDur=r?r<0?1e10:bt(o*(r+1)+e._rDelay*r):o,a>0&&!i&&Ko(e,e._tTime=e._tDur*a),e.parent&&Yo(e),n||Wi(e.parent,e),e},yh=function(e){return e instanceof Gt?Wi(e):Wr(e,e._dur)},jy={_start:0,endTime:As,totalDuration:As},dn=function s(e,t,n){var i=e.labels,r=e._recent||jy,o=e.duration()>=mn?r.endTime(!1):e._dur,a,l,c;return wt(t)&&(isNaN(t)||t in i)?(l=t.charAt(0),c=t.substr(-1)==="%",a=t.indexOf("="),l==="<"||l===">"?(a>=0&&(t=t.replace(/=/,"")),(l==="<"?r._start:r.endTime(r._repeat>=0))+(parseFloat(t.substr(1))||0)*(c?(a<0?r:n).totalDuration()/100:1)):a<0?(t in i||(i[t]=o),i[t]):(l=parseFloat(t.charAt(a-1)+t.substr(a+1)),c&&n&&(l=l/100*(Bt(n)?n[0]:n).totalDuration()),a>1?s(e,t.substr(0,a-1),n)+l:o+l)):t==null?o:+t},ys=function(e,t,n){var i=ti(t[1]),r=(i?2:1)+(e<2?0:1),o=t[r],a,l;if(i&&(o.duration=t[1]),o.parent=n,e){for(a=o,l=n;l&&!("immediateRender"in a);)a=l.vars.defaults||{},l=Yt(l.vars.inherit)&&l.parent;o.immediateRender=Yt(a.immediateRender),e<2?o.runBackwards=1:o.startAt=t[r-1]}return new yt(t[0],o,t[r+1])},wi=function(e,t){return e||e===0?t(e):t},Fs=function(e,t,n){return n<e?e:n>t?t:n},Ut=function(e,t){return!wt(e)||!(t=Dy.exec(e))?"":t[1]},Wy=function(e,t,n){return wi(n,function(i){return Fs(e,t,i)})},Nl=[].slice,Od=function(e,t){return e&&Un(e)&&"length"in e&&(!t&&!e.length||e.length-1 in e&&Un(e[0]))&&!e.nodeType&&e!==wn},Xy=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(i){var r;return wt(i)&&!t||Od(i,1)?(r=n).push.apply(r,gn(i)):n.push(i)})||n},gn=function(e,t,n){return st&&!t&&st.selector?st.selector(e):wt(e)&&!n&&(Pl||!Xr())?Nl.call((t||vc).querySelectorAll(e),0):Bt(e)?Xy(e,n):Od(e)?Nl.call(e,0):e?[e]:[]},Ul=function(e){return e=gn(e)[0]||bs("Invalid scope")||{},function(t){var n=e.current||e.nativeElement||e;return gn(t,n.querySelectorAll?n:n===e?bs("Invalid scope")||vc.createElement("div"):e)}},Fd=function(e){return e.sort(function(){return .5-Math.random()})},Bd=function(e){if(ft(e))return e;var t=Un(e)?e:{each:e},n=Xi(t.ease),i=t.from||0,r=parseFloat(t.base)||0,o={},a=i>0&&i<1,l=isNaN(i)||a,c=t.axis,u=i,h=i;return wt(i)?u=h={center:.5,edges:.5,end:1}[i]||0:!a&&l&&(u=i[0],h=i[1]),function(d,f,_){var m=(_||t).length,g=o[m],p,y,x,v,w,T,E,C,S;if(!g){if(S=t.grid==="auto"?0:(t.grid||[1,mn])[1],!S){for(E=-mn;E<(E=_[S++].getBoundingClientRect().left)&&S<m;);S<m&&S--}for(g=o[m]=[],p=l?Math.min(S,m)*u-.5:i%S,y=S===mn?0:l?m*h/S-.5:i/S|0,E=0,C=mn,T=0;T<m;T++)x=T%S-p,v=y-(T/S|0),g[T]=w=c?Math.abs(c==="y"?v:x):yd(x*x+v*v),w>E&&(E=w),w<C&&(C=w);i==="random"&&Fd(g),g.max=E-C,g.min=C,g.v=m=(parseFloat(t.amount)||parseFloat(t.each)*(S>m?m-1:c?c==="y"?m/S:S:Math.max(S,m/S))||0)*(i==="edges"?-1:1),g.b=m<0?r-m:r,g.u=Ut(t.amount||t.each)||0,n=n&&m<0?Kd(n):n}return m=(g[d]-g.min)/g.max||0,bt(g.b+(n?n(m):m)*g.v)+g.u}},Ol=function(e){var t=Math.pow(10,((e+"").split(".")[1]||"").length);return function(n){var i=bt(Math.round(parseFloat(n)/e)*e*t);return(i-i%1)/t+(ti(n)?0:Ut(n))}},kd=function(e,t){var n=Bt(e),i,r;return!n&&Un(e)&&(i=n=e.radius||mn,e.values?(e=gn(e.values),(r=!ti(e[0]))&&(i*=i)):e=Ol(e.increment)),wi(t,n?ft(e)?function(o){return r=e(o),Math.abs(r-o)<=i?r:o}:function(o){for(var a=parseFloat(r?o.x:o),l=parseFloat(r?o.y:0),c=mn,u=0,h=e.length,d,f;h--;)r?(d=e[h].x-a,f=e[h].y-l,d=d*d+f*f):d=Math.abs(e[h]-a),d<c&&(c=d,u=h);return u=!i||c<=i?e[u]:o,r||u===o||ti(o)?u:u+Ut(o)}:Ol(e))},zd=function(e,t,n,i){return wi(Bt(e)?!t:n===!0?!!(n=0):!i,function(){return Bt(e)?e[~~(Math.random()*e.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*i)/i})},Yy=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(i){return t.reduce(function(r,o){return o(r)},i)}},Ky=function(e,t){return function(n){return e(parseFloat(n))+(t||Ut(n))}},qy=function(e,t,n){return Vd(e,t,0,1,n)},Hd=function(e,t,n){return wi(n,function(i){return e[~~t(i)]})},Zy=function s(e,t,n){var i=t-e;return Bt(e)?Hd(e,s(0,e.length),t):wi(n,function(r){return(i+(r-e)%i)%i+e})},$y=function s(e,t,n){var i=t-e,r=i*2;return Bt(e)?Hd(e,s(0,e.length-1),t):wi(n,function(o){return o=(r+(o-e)%r)%r||0,e+(o>i?r-o:o)})},ws=function(e){for(var t=0,n="",i,r,o,a;~(i=e.indexOf("random(",t));)o=e.indexOf(")",i),a=e.charAt(i+7)==="[",r=e.substr(i+7,o-i-7).match(a?Td:Cl),n+=e.substr(t,i-t)+zd(a?r:+r[0],a?0:+r[1],+r[2]||1e-5),t=o+1;return n+e.substr(t,e.length-t)},Vd=function(e,t,n,i,r){var o=t-e,a=i-n;return wi(r,function(l){return n+((l-e)/o*a||0)})},Jy=function s(e,t,n,i){var r=isNaN(e+t)?0:function(f){return(1-f)*e+f*t};if(!r){var o=wt(e),a={},l,c,u,h,d;if(n===!0&&(i=1)&&(n=null),o)e={p:e},t={p:t};else if(Bt(e)&&!Bt(t)){for(u=[],h=e.length,d=h-2,c=1;c<h;c++)u.push(s(e[c-1],e[c]));h--,r=function(_){_*=h;var m=Math.min(d,~~_);return u[m](_-m)},n=t}else i||(e=Zi(Bt(e)?[]:{},e));if(!u){for(l in t)bc.call(a,e,l,"get",t[l]);r=function(_){return Cc(_,a)||(o?e.p:e)}}}return wi(n,r)},vh=function(e,t,n){var i=e.labels,r=mn,o,a,l;for(o in i)a=i[o]-t,a<0==!!n&&a&&r>(a=Math.abs(a))&&(l=o,r=a);return l},on=function(e,t,n){var i=e.vars,r=i[t],o=st,a=e._ctx,l,c,u;if(r)return l=i[t+"Params"],c=i.callbackScope||e,n&&Ti.length&&Oo(),a&&(st=a),u=l?r.apply(c,l):r.call(c),st=o,u},fs=function(e){return bi(e),e.scrollTrigger&&e.scrollTrigger.kill(!!Ft),e.progress()<1&&on(e,"onInterrupt"),e},Er,Gd=[],jd=function(e){if(e)if(e=!e.name&&e.default||e,yc()||e.headless){var t=e.name,n=ft(e),i=t&&!n&&e.init?function(){this._props=[]}:e,r={init:As,render:Cc,add:bc,kill:pv,modifier:fv,rawVars:0},o={targetTest:0,get:0,getSetter:Rc,aliases:{},register:0};if(Xr(),e!==i){if(nn[t])return;_n(i,_n(Fo(e,r),o)),Zi(i.prototype,Zi(r,Fo(e,o))),nn[i.prop=t]=i,e.targetTest&&(bo.push(i),Sc[t]=1),t=(t==="css"?"CSS":t.charAt(0).toUpperCase()+t.substr(1))+"Plugin"}Ad(t,i),e.register&&e.register($t,i,qt)}else Gd.push(e)},et=255,ps={aqua:[0,et,et],lime:[0,et,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,et],navy:[0,0,128],white:[et,et,et],olive:[128,128,0],yellow:[et,et,0],orange:[et,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[et,0,0],pink:[et,192,203],cyan:[0,et,et],transparent:[et,et,et,0]},Oa=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*et+.5|0},Wd=function(e,t,n){var i=e?ti(e)?[e>>16,e>>8&et,e&et]:0:ps.black,r,o,a,l,c,u,h,d,f,_;if(!i){if(e.substr(-1)===","&&(e=e.substr(0,e.length-1)),ps[e])i=ps[e];else if(e.charAt(0)==="#"){if(e.length<6&&(r=e.charAt(1),o=e.charAt(2),a=e.charAt(3),e="#"+r+r+o+o+a+a+(e.length===5?e.charAt(4)+e.charAt(4):"")),e.length===9)return i=parseInt(e.substr(1,6),16),[i>>16,i>>8&et,i&et,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),i=[e>>16,e>>8&et,e&et]}else if(e.substr(0,3)==="hsl"){if(i=_=e.match(Cl),!t)l=+i[0]%360/360,c=+i[1]/100,u=+i[2]/100,o=u<=.5?u*(c+1):u+c-u*c,r=u*2-o,i.length>3&&(i[3]*=1),i[0]=Oa(l+1/3,r,o),i[1]=Oa(l,r,o),i[2]=Oa(l-1/3,r,o);else if(~e.indexOf("="))return i=e.match(Md),n&&i.length<4&&(i[3]=1),i}else i=e.match(Cl)||ps.transparent;i=i.map(Number)}return t&&!_&&(r=i[0]/et,o=i[1]/et,a=i[2]/et,h=Math.max(r,o,a),d=Math.min(r,o,a),u=(h+d)/2,h===d?l=c=0:(f=h-d,c=u>.5?f/(2-h-d):f/(h+d),l=h===r?(o-a)/f+(o<a?6:0):h===o?(a-r)/f+2:(r-o)/f+4,l*=60),i[0]=~~(l+.5),i[1]=~~(c*100+.5),i[2]=~~(u*100+.5)),n&&i.length<4&&(i[3]=1),i},Xd=function(e){var t=[],n=[],i=-1;return e.split(Ei).forEach(function(r){var o=r.match(Tr)||[];t.push.apply(t,o),n.push(i+=o.length+1)}),t.c=n,t},Mh=function(e,t,n){var i="",r=(e+i).match(Ei),o=t?"hsla(":"rgba(",a=0,l,c,u,h;if(!r)return e;if(r=r.map(function(d){return(d=Wd(d,t,1))&&o+(t?d[0]+","+d[1]+"%,"+d[2]+"%,"+d[3]:d.join(","))+")"}),n&&(u=Xd(e),l=n.c,l.join(i)!==u.c.join(i)))for(c=e.replace(Ei,"1").split(Tr),h=c.length-1;a<h;a++)i+=c[a]+(~l.indexOf(a)?r.shift()||o+"0,0,0,0)":(u.length?u:r.length?r:n).shift());if(!c)for(c=e.split(Ei),h=c.length-1;a<h;a++)i+=c[a]+r[a];return i+c[h]},Ei=function(){var s="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",e;for(e in ps)s+="|"+e+"\\b";return new RegExp(s+")","gi")}(),Qy=/hsl[a]?\(/,Yd=function(e){var t=e.join(" "),n;if(Ei.lastIndex=0,Ei.test(t))return n=Qy.test(t),e[1]=Mh(e[1],n),e[0]=Mh(e[0],n,Xd(e[1])),!0},Rs,sn=function(){var s=Date.now,e=500,t=33,n=s(),i=n,r=1e3/240,o=r,a=[],l,c,u,h,d,f,_=function m(g){var p=s()-i,y=g===!0,x,v,w,T;if((p>e||p<0)&&(n+=p-t),i+=p,w=i-n,x=w-o,(x>0||y)&&(T=++h.frame,d=w-h.time*1e3,h.time=w=w/1e3,o+=x+(x>=r?4:r-x),v=1),y||(l=c(m)),v)for(f=0;f<a.length;f++)a[f](w,d,T,g)};return h={time:0,frame:0,tick:function(){_(!0)},deltaRatio:function(g){return d/(1e3/(g||60))},wake:function(){Ed&&(!Pl&&yc()&&(wn=Pl=window,vc=wn.document||{},ln.gsap=$t,(wn.gsapVersions||(wn.gsapVersions=[])).push($t.version),bd(Uo||wn.GreenSockGlobals||!wn.gsap&&wn||{}),Gd.forEach(jd)),u=typeof requestAnimationFrame<"u"&&requestAnimationFrame,l&&h.sleep(),c=u||function(g){return setTimeout(g,o-h.time*1e3+1|0)},Rs=1,_(2))},sleep:function(){(u?cancelAnimationFrame:clearTimeout)(l),Rs=0,c=As},lagSmoothing:function(g,p){e=g||1/0,t=Math.min(p||33,e)},fps:function(g){r=1e3/(g||240),o=h.time*1e3+r},add:function(g,p,y){var x=p?function(v,w,T,E){g(v,w,T,E),h.remove(x)}:g;return h.remove(g),a[y?"unshift":"push"](x),Xr(),x},remove:function(g,p){~(p=a.indexOf(g))&&a.splice(p,1)&&f>=p&&f--},_listeners:a},h}(),Xr=function(){return!Rs&&sn.wake()},Ge={},ev=/^[\d.\-M][\d.\-,\s]/,tv=/["']/g,nv=function(e){for(var t={},n=e.substr(1,e.length-3).split(":"),i=n[0],r=1,o=n.length,a,l,c;r<o;r++)l=n[r],a=r!==o-1?l.lastIndexOf(","):l.length,c=l.substr(0,a),t[i]=isNaN(c)?c.replace(tv,"").trim():+c,i=l.substr(a+1).trim();return t},iv=function(e){var t=e.indexOf("(")+1,n=e.indexOf(")"),i=e.indexOf("(",t);return e.substring(t,~i&&i<n?e.indexOf(")",n+1):n)},rv=function(e){var t=(e+"").split("("),n=Ge[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf("{")?[nv(t[1])]:iv(e).split(",").map(Pd)):Ge._CE&&ev.test(e)?Ge._CE("",e):n},Kd=function(e){return function(t){return 1-e(1-t)}},qd=function s(e,t){for(var n=e._first,i;n;)n instanceof Gt?s(n,t):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==t&&(n.timeline?s(n.timeline,t):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=t)),n=n._next},Xi=function(e,t){return e&&(ft(e)?e:Ge[e]||rv(e))||t},Qi=function(e,t,n,i){n===void 0&&(n=function(l){return 1-t(1-l)}),i===void 0&&(i=function(l){return l<.5?t(l*2)/2:1-t((1-l)*2)/2});var r={easeIn:t,easeOut:n,easeInOut:i},o;return Kt(e,function(a){Ge[a]=ln[a]=r,Ge[o=a.toLowerCase()]=n;for(var l in r)Ge[o+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=Ge[a+"."+l]=r[l]}),r},Zd=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},Fa=function s(e,t,n){var i=t>=1?t:1,r=(n||(e?.3:.45))/(t<1?t:1),o=r/Rl*(Math.asin(1/i)||0),a=function(u){return u===1?1:i*Math.pow(2,-10*u)*Iy((u-o)*r)+1},l=e==="out"?a:e==="in"?function(c){return 1-a(1-c)}:Zd(a);return r=Rl/r,l.config=function(c,u){return s(e,c,u)},l},Ba=function s(e,t){t===void 0&&(t=1.70158);var n=function(o){return o?--o*o*((t+1)*o+t)+1:0},i=e==="out"?n:e==="in"?function(r){return 1-n(1-r)}:Zd(n);return i.config=function(r){return s(e,r)},i};Kt("Linear,Quad,Cubic,Quart,Quint,Strong",function(s,e){var t=e<5?e+1:e;Qi(s+",Power"+(t-1),e?function(n){return Math.pow(n,t)}:function(n){return n},function(n){return 1-Math.pow(1-n,t)},function(n){return n<.5?Math.pow(n*2,t)/2:1-Math.pow((1-n)*2,t)/2})});Ge.Linear.easeNone=Ge.none=Ge.Linear.easeIn;Qi("Elastic",Fa("in"),Fa("out"),Fa());(function(s,e){var t=1/e,n=2*t,i=2.5*t,r=function(a){return a<t?s*a*a:a<n?s*Math.pow(a-1.5/e,2)+.75:a<i?s*(a-=2.25/e)*a+.9375:s*Math.pow(a-2.625/e,2)+.984375};Qi("Bounce",function(o){return 1-r(1-o)},r)})(7.5625,2.75);Qi("Expo",function(s){return s?Math.pow(2,10*(s-1)):0});Qi("Circ",function(s){return-(yd(1-s*s)-1)});Qi("Sine",function(s){return s===1?1:-Ly(s*Cy)+1});Qi("Back",Ba("in"),Ba("out"),Ba());Ge.SteppedEase=Ge.steps=ln.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,i=e+(t?0:1),r=t?1:0,o=1-tt;return function(a){return((i*Fs(0,o,a)|0)+r)*n}}};Gr.ease=Ge["quad.out"];Kt("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(s){return Tc+=s+","+s+"Params,"});var $d=function(e,t){this.id=Py++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:Rd,this.set=t?t.getSetter:Rc},Cs=function(){function s(t){this.vars=t,this._delay=+t.delay||0,(this._repeat=t.repeat===1/0?-2:t.repeat||0)&&(this._rDelay=t.repeatDelay||0,this._yoyo=!!t.yoyo||!!t.yoyoEase),this._ts=1,Wr(this,+t.duration,1,1),this.data=t.data,st&&(this._ctx=st,st.data.push(this)),Rs||sn.wake()}var e=s.prototype;return e.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},e.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},e.totalDuration=function(n){return arguments.length?(this._dirty=0,Wr(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},e.totalTime=function(n,i){if(Xr(),!arguments.length)return this._tTime;var r=this._dp;if(r&&r.smoothChildTiming&&this._ts){for(Ko(this,n),!r._dp||r.parent||Dd(r,this);r&&r.parent;)r.parent._time!==r._start+(r._ts>=0?r._tTime/r._ts:(r.totalDuration()-r._tTime)/-r._ts)&&r.totalTime(r._tTime,!0),r=r.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&Ln(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===tt||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),Cd(this,n,i)),this},e.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+xh(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},e.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>0?1:0},e.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+xh(this),i):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},e.iteration=function(n,i){var r=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*r,i):this._repeat?jr(this._tTime,r)+1:1},e.timeScale=function(n,i){if(!arguments.length)return this._rts===-tt?0:this._rts;if(this._rts===n)return this;var r=this.parent&&this._ts?Bo(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-tt?0:this._rts,this.totalTime(Fs(-Math.abs(this._delay),this._tDur,r),i!==!1),Yo(this),ky(this)},e.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(Xr(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==tt&&(this._tTime-=tt)))),this):this._ps},e.startTime=function(n){if(arguments.length){this._start=n;var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&Ln(i,this,n-this._delay),this}return this._start},e.endTime=function(n){return this._start+(Yt(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},e.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Bo(i.rawTime(n),this):this._tTime:this._tTime},e.revert=function(n){n===void 0&&(n=Uy);var i=Ft;return Ft=n,(this._initted||this._startAt)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),Ft=i,this},e.globalTime=function(n){for(var i=this,r=arguments.length?n:i.rawTime();i;)r=i._start+r/(Math.abs(i._ts)||1),i=i._dp;return!this.parent&&this._sat?this._sat.globalTime(n):r},e.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,yh(this)):this._repeat===-2?1/0:this._repeat},e.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,yh(this),i?this.time(i):this}return this._rDelay},e.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},e.seek=function(n,i){return this.totalTime(dn(this,n),Yt(i))},e.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,Yt(i))},e.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},e.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},e.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},e.resume=function(){return this.paused(!1)},e.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-tt:0)),this):this._rts<0},e.invalidate=function(){return this._initted=this._act=0,this._zTime=-tt,this},e.isActive=function(){var n=this.parent||this._dp,i=this._start,r;return!!(!n||this._ts&&this._initted&&n.isActive()&&(r=n.rawTime(!0))>=i&&r<this.endTime(!0)-tt)},e.eventCallback=function(n,i,r){var o=this.vars;return arguments.length>1?(i?(o[n]=i,r&&(o[n+"Params"]=r),n==="onUpdate"&&(this._onUpdate=i)):delete o[n],this):o[n]},e.then=function(n){var i=this;return new Promise(function(r){var o=ft(n)?n:Ld,a=function(){var c=i.then;i.then=null,ft(o)&&(o=o(i))&&(o.then||o===i)&&(i.then=c),r(o),i.then=c};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?a():i._prom=a})},e.kill=function(){fs(this)},s}();_n(Cs.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-tt,_prom:0,_ps:!1,_rts:1});var Gt=function(s){xd(e,s);function e(n,i){var r;return n===void 0&&(n={}),r=s.call(this,n)||this,r.labels={},r.smoothChildTiming=!!n.smoothChildTiming,r.autoRemoveChildren=!!n.autoRemoveChildren,r._sort=Yt(n.sortChildren),at&&Ln(n.parent||at,Kn(r),i),n.reversed&&r.reverse(),n.paused&&r.paused(!0),n.scrollTrigger&&Nd(Kn(r),n.scrollTrigger),r}var t=e.prototype;return t.to=function(i,r,o){return ys(0,arguments,this),this},t.from=function(i,r,o){return ys(1,arguments,this),this},t.fromTo=function(i,r,o,a){return ys(2,arguments,this),this},t.set=function(i,r,o){return r.duration=0,r.parent=this,xs(r).repeatDelay||(r.repeat=0),r.immediateRender=!!r.immediateRender,new yt(i,r,dn(this,o),1),this},t.call=function(i,r,o){return Ln(this,yt.delayedCall(0,i,r),o)},t.staggerTo=function(i,r,o,a,l,c,u){return o.duration=r,o.stagger=o.stagger||a,o.onComplete=c,o.onCompleteParams=u,o.parent=this,new yt(i,o,dn(this,l)),this},t.staggerFrom=function(i,r,o,a,l,c,u){return o.runBackwards=1,xs(o).immediateRender=Yt(o.immediateRender),this.staggerTo(i,r,o,a,l,c,u)},t.staggerFromTo=function(i,r,o,a,l,c,u,h){return a.startAt=o,xs(a).immediateRender=Yt(a.immediateRender),this.staggerTo(i,r,a,l,c,u,h)},t.render=function(i,r,o){var a=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,u=i<=0?0:bt(i),h=this._zTime<0!=i<0&&(this._initted||!c),d,f,_,m,g,p,y,x,v,w,T,E;if(this!==at&&u>l&&i>=0&&(u=l),u!==this._tTime||o||h){if(a!==this._time&&c&&(u+=this._time-a,i+=this._time-a),d=u,v=this._start,x=this._ts,p=!x,h&&(c||(a=this._zTime),(i||!r)&&(this._zTime=i)),this._repeat){if(T=this._yoyo,g=c+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(g*100+i,r,o);if(d=bt(u%g),u===l?(m=this._repeat,d=c):(m=~~(u/g),m&&m===u/g&&(d=c,m--),d>c&&(d=c)),w=jr(this._tTime,g),!a&&this._tTime&&w!==m&&this._tTime-w*g-this._dur<=0&&(w=m),T&&m&1&&(d=c-d,E=1),m!==w&&!this._lock){var C=T&&w&1,S=C===(T&&m&1);if(m<w&&(C=!C),a=C?0:u%c?c:u,this._lock=1,this.render(a||(E?0:bt(m*g)),r,!c)._lock=0,this._tTime=u,!r&&this.parent&&on(this,"onRepeat"),this.vars.repeatRefresh&&!E&&(this.invalidate()._lock=1),a&&a!==this._time||p!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,S&&(this._lock=2,a=C?c:-1e-4,this.render(a,!0),this.vars.repeatRefresh&&!E&&this.invalidate()),this._lock=0,!this._ts&&!p)return this;qd(this,E)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(y=Gy(this,bt(a),bt(d)),y&&(u-=d-(d=y._start))),this._tTime=u,this._time=d,this._act=!x,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,a=0),!a&&d&&!r&&!m&&(on(this,"onStart"),this._tTime!==u))return this;if(d>=a&&i>=0)for(f=this._first;f;){if(_=f._next,(f._act||d>=f._start)&&f._ts&&y!==f){if(f.parent!==this)return this.render(i,r,o);if(f.render(f._ts>0?(d-f._start)*f._ts:(f._dirty?f.totalDuration():f._tDur)+(d-f._start)*f._ts,r,o),d!==this._time||!this._ts&&!p){y=0,_&&(u+=this._zTime=-tt);break}}f=_}else{f=this._last;for(var b=i<0?i:d;f;){if(_=f._prev,(f._act||b<=f._end)&&f._ts&&y!==f){if(f.parent!==this)return this.render(i,r,o);if(f.render(f._ts>0?(b-f._start)*f._ts:(f._dirty?f.totalDuration():f._tDur)+(b-f._start)*f._ts,r,o||Ft&&(f._initted||f._startAt)),d!==this._time||!this._ts&&!p){y=0,_&&(u+=this._zTime=b?-tt:tt);break}}f=_}}if(y&&!r&&(this.pause(),y.render(d>=a?0:-tt)._zTime=d>=a?1:-1,this._ts))return this._start=v,Yo(this),this.render(i,r,o);this._onUpdate&&!r&&on(this,"onUpdate",!0),(u===l&&this._tTime>=this.totalDuration()||!u&&a)&&(v===this._start||Math.abs(x)!==Math.abs(this._ts))&&(this._lock||((i||!c)&&(u===l&&this._ts>0||!u&&this._ts<0)&&bi(this,1),!r&&!(i<0&&!a)&&(u||a||!l)&&(on(this,u===l&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom())))}return this},t.add=function(i,r){var o=this;if(ti(r)||(r=dn(this,r,i)),!(i instanceof Cs)){if(Bt(i))return i.forEach(function(a){return o.add(a,r)}),this;if(wt(i))return this.addLabel(i,r);if(ft(i))i=yt.delayedCall(0,i);else return this}return this!==i?Ln(this,i,r):this},t.getChildren=function(i,r,o,a){i===void 0&&(i=!0),r===void 0&&(r=!0),o===void 0&&(o=!0),a===void 0&&(a=-mn);for(var l=[],c=this._first;c;)c._start>=a&&(c instanceof yt?r&&l.push(c):(o&&l.push(c),i&&l.push.apply(l,c.getChildren(!0,r,o)))),c=c._next;return l},t.getById=function(i){for(var r=this.getChildren(1,1,1),o=r.length;o--;)if(r[o].vars.id===i)return r[o]},t.remove=function(i){return wt(i)?this.removeLabel(i):ft(i)?this.killTweensOf(i):(Xo(this,i),i===this._recent&&(this._recent=this._last),Wi(this))},t.totalTime=function(i,r){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=bt(sn.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),s.prototype.totalTime.call(this,i,r),this._forcing=0,this):this._tTime},t.addLabel=function(i,r){return this.labels[i]=dn(this,r),this},t.removeLabel=function(i){return delete this.labels[i],this},t.addPause=function(i,r,o){var a=yt.delayedCall(0,r||As,o);return a.data="isPause",this._hasPause=1,Ln(this,a,dn(this,i))},t.removePause=function(i){var r=this._first;for(i=dn(this,i);r;)r._start===i&&r.data==="isPause"&&bi(r),r=r._next},t.killTweensOf=function(i,r,o){for(var a=this.getTweensOf(i,o),l=a.length;l--;)xi!==a[l]&&a[l].kill(i,r);return this},t.getTweensOf=function(i,r){for(var o=[],a=gn(i),l=this._first,c=ti(r),u;l;)l instanceof yt?Oy(l._targets,a)&&(c?(!xi||l._initted&&l._ts)&&l.globalTime(0)<=r&&l.globalTime(l.totalDuration())>r:!r||l.isActive())&&o.push(l):(u=l.getTweensOf(a,r)).length&&o.push.apply(o,u),l=l._next;return o},t.tweenTo=function(i,r){r=r||{};var o=this,a=dn(o,i),l=r,c=l.startAt,u=l.onStart,h=l.onStartParams,d=l.immediateRender,f,_=yt.to(o,_n({ease:r.ease||"none",lazy:!1,immediateRender:!1,time:a,overwrite:"auto",duration:r.duration||Math.abs((a-(c&&"time"in c?c.time:o._time))/o.timeScale())||tt,onStart:function(){if(o.pause(),!f){var g=r.duration||Math.abs((a-(c&&"time"in c?c.time:o._time))/o.timeScale());_._dur!==g&&Wr(_,g,0,1).render(_._time,!0,!0),f=1}u&&u.apply(_,h||[])}},r));return d?_.render(0):_},t.tweenFromTo=function(i,r,o){return this.tweenTo(r,_n({startAt:{time:dn(this,i)}},o))},t.recent=function(){return this._recent},t.nextLabel=function(i){return i===void 0&&(i=this._time),vh(this,dn(this,i))},t.previousLabel=function(i){return i===void 0&&(i=this._time),vh(this,dn(this,i),1)},t.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+tt)},t.shiftChildren=function(i,r,o){o===void 0&&(o=0);for(var a=this._first,l=this.labels,c;a;)a._start>=o&&(a._start+=i,a._end+=i),a=a._next;if(r)for(c in l)l[c]>=o&&(l[c]+=i);return Wi(this)},t.invalidate=function(i){var r=this._first;for(this._lock=0;r;)r.invalidate(i),r=r._next;return s.prototype.invalidate.call(this,i)},t.clear=function(i){i===void 0&&(i=!0);for(var r=this._first,o;r;)o=r._next,this.remove(r),r=o;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),Wi(this)},t.totalDuration=function(i){var r=0,o=this,a=o._last,l=mn,c,u,h;if(arguments.length)return o.timeScale((o._repeat<0?o.duration():o.totalDuration())/(o.reversed()?-i:i));if(o._dirty){for(h=o.parent;a;)c=a._prev,a._dirty&&a.totalDuration(),u=a._start,u>l&&o._sort&&a._ts&&!o._lock?(o._lock=1,Ln(o,a,u-a._delay,1)._lock=0):l=u,u<0&&a._ts&&(r-=u,(!h&&!o._dp||h&&h.smoothChildTiming)&&(o._start+=u/o._ts,o._time-=u,o._tTime-=u),o.shiftChildren(-u,!1,-1/0),l=0),a._end>r&&a._ts&&(r=a._end),a=c;Wr(o,o===at&&o._time>r?o._time:r,1,1),o._dirty=0}return o._tDur},e.updateRoot=function(i){if(at._ts&&(Cd(at,Bo(i,at)),wd=sn.frame),sn.frame>=gh){gh+=an.autoSleep||120;var r=at._first;if((!r||!r._ts)&&an.autoSleep&&sn._listeners.length<2){for(;r&&!r._ts;)r=r._next;r||sn.sleep()}}},e}(Cs);_n(Gt.prototype,{_lock:0,_hasPause:0,_forcing:0});var sv=function(e,t,n,i,r,o,a){var l=new qt(this._pt,e,t,0,1,rf,null,r),c=0,u=0,h,d,f,_,m,g,p,y;for(l.b=n,l.e=i,n+="",i+="",(p=~i.indexOf("random("))&&(i=ws(i)),o&&(y=[n,i],o(y,e,t),n=y[0],i=y[1]),d=n.match(Na)||[];h=Na.exec(i);)_=h[0],m=i.substring(c,h.index),f?f=(f+1)%5:m.substr(-5)==="rgba("&&(f=1),_!==d[u++]&&(g=parseFloat(d[u-1])||0,l._pt={_next:l._pt,p:m||u===1?m:",",s:g,c:_.charAt(1)==="="?Pr(g,_)-g:parseFloat(_)-g,m:f&&f<4?Math.round:0},c=Na.lastIndex);return l.c=c<i.length?i.substring(c,i.length):"",l.fp=a,(Sd.test(i)||p)&&(l.e=0),this._pt=l,l},bc=function(e,t,n,i,r,o,a,l,c,u){ft(i)&&(i=i(r||0,e,o));var h=e[t],d=n!=="get"?n:ft(h)?c?e[t.indexOf("set")||!ft(e["get"+t.substr(3)])?t:"get"+t.substr(3)](c):e[t]():h,f=ft(h)?c?uv:tf:wc,_;if(wt(i)&&(~i.indexOf("random(")&&(i=ws(i)),i.charAt(1)==="="&&(_=Pr(d,i)+(Ut(d)||0),(_||_===0)&&(i=_))),!u||d!==i||Fl)return!isNaN(d*i)&&i!==""?(_=new qt(this._pt,e,t,+d||0,i-(d||0),typeof h=="boolean"?dv:nf,0,f),c&&(_.fp=c),a&&_.modifier(a,this,e),this._pt=_):(!h&&!(t in e)&&Mc(t,i),sv.call(this,e,t,d,i,f,l||an.stringFilter,c))},ov=function(e,t,n,i,r){if(ft(e)&&(e=vs(e,r,t,n,i)),!Un(e)||e.style&&e.nodeType||Bt(e)||vd(e))return wt(e)?vs(e,r,t,n,i):e;var o={},a;for(a in e)o[a]=vs(e[a],r,t,n,i);return o},Jd=function(e,t,n,i,r,o){var a,l,c,u;if(nn[e]&&(a=new nn[e]).init(r,a.rawVars?t[e]:ov(t[e],i,r,o,n),n,i,o)!==!1&&(n._pt=l=new qt(n._pt,r,e,0,1,a.render,a,0,a.priority),n!==Er))for(c=n._ptLookup[n._targets.indexOf(r)],u=a._props.length;u--;)c[a._props[u]]=l;return a},xi,Fl,Ac=function s(e,t,n){var i=e.vars,r=i.ease,o=i.startAt,a=i.immediateRender,l=i.lazy,c=i.onUpdate,u=i.runBackwards,h=i.yoyoEase,d=i.keyframes,f=i.autoRevert,_=e._dur,m=e._startAt,g=e._targets,p=e.parent,y=p&&p.data==="nested"?p.vars.targets:g,x=e._overwrite==="auto"&&!_c,v=e.timeline,w,T,E,C,S,b,L,B,U,K,q,H,W;if(v&&(!d||!r)&&(r="none"),e._ease=Xi(r,Gr.ease),e._yEase=h?Kd(Xi(h===!0?r:h,Gr.ease)):0,h&&e._yoyo&&!e._repeat&&(h=e._yEase,e._yEase=e._ease,e._ease=h),e._from=!v&&!!i.runBackwards,!v||d&&!i.stagger){if(B=g[0]?ji(g[0]).harness:0,H=B&&i[B.prop],w=Fo(i,Sc),m&&(m._zTime<0&&m.progress(1),t<0&&u&&a&&!f?m.render(-1,!0):m.revert(u&&_?Eo:Ny),m._lazy=0),o){if(bi(e._startAt=yt.set(g,_n({data:"isStart",overwrite:!1,parent:p,immediateRender:!0,lazy:!m&&Yt(l),startAt:null,delay:0,onUpdate:c&&function(){return on(e,"onUpdate")},stagger:0},o))),e._startAt._dp=0,e._startAt._sat=e,t<0&&(Ft||!a&&!f)&&e._startAt.revert(Eo),a&&_&&t<=0&&n<=0){t&&(e._zTime=t);return}}else if(u&&_&&!m){if(t&&(a=!1),E=_n({overwrite:!1,data:"isFromStart",lazy:a&&!m&&Yt(l),immediateRender:a,stagger:0,parent:p},w),H&&(E[B.prop]=H),bi(e._startAt=yt.set(g,E)),e._startAt._dp=0,e._startAt._sat=e,t<0&&(Ft?e._startAt.revert(Eo):e._startAt.render(-1,!0)),e._zTime=t,!a)s(e._startAt,tt,tt);else if(!t)return}for(e._pt=e._ptCache=0,l=_&&Yt(l)||l&&!_,T=0;T<g.length;T++){if(S=g[T],L=S._gsap||Ec(g)[T]._gsap,e._ptLookup[T]=K={},Ll[L.id]&&Ti.length&&Oo(),q=y===g?T:y.indexOf(S),B&&(U=new B).init(S,H||w,e,q,y)!==!1&&(e._pt=C=new qt(e._pt,S,U.name,0,1,U.render,U,0,U.priority),U._props.forEach(function(G){K[G]=C}),U.priority&&(b=1)),!B||H)for(E in w)nn[E]&&(U=Jd(E,w,e,q,S,y))?U.priority&&(b=1):K[E]=C=bc.call(e,S,E,"get",w[E],q,y,0,i.stringFilter);e._op&&e._op[T]&&e.kill(S,e._op[T]),x&&e._pt&&(xi=e,at.killTweensOf(S,K,e.globalTime(t)),W=!e.parent,xi=0),e._pt&&l&&(Ll[L.id]=1)}b&&sf(e),e._onInit&&e._onInit(e)}e._onUpdate=c,e._initted=(!e._op||e._pt)&&!W,d&&t<=0&&v.render(mn,!0,!0)},av=function(e,t,n,i,r,o,a,l){var c=(e._pt&&e._ptCache||(e._ptCache={}))[t],u,h,d,f;if(!c)for(c=e._ptCache[t]=[],d=e._ptLookup,f=e._targets.length;f--;){if(u=d[f][t],u&&u.d&&u.d._pt)for(u=u.d._pt;u&&u.p!==t&&u.fp!==t;)u=u._next;if(!u)return Fl=1,e.vars[t]="+=0",Ac(e,a),Fl=0,l?bs(t+" not eligible for reset"):1;c.push(u)}for(f=c.length;f--;)h=c[f],u=h._pt||h,u.s=(i||i===0)&&!r?i:u.s+(i||0)+o*u.c,u.c=n-u.s,h.e&&(h.e=mt(n)+Ut(h.e)),h.b&&(h.b=u.s+Ut(h.b))},lv=function(e,t){var n=e[0]?ji(e[0]).harness:0,i=n&&n.aliases,r,o,a,l;if(!i)return t;r=Zi({},t);for(o in i)if(o in r)for(l=i[o].split(","),a=l.length;a--;)r[l[a]]=r[o];return r},cv=function(e,t,n,i){var r=t.ease||i||"power1.inOut",o,a;if(Bt(t))a=n[e]||(n[e]=[]),t.forEach(function(l,c){return a.push({t:c/(t.length-1)*100,v:l,e:r})});else for(o in t)a=n[o]||(n[o]=[]),o==="ease"||a.push({t:parseFloat(e),v:t[o],e:r})},vs=function(e,t,n,i,r){return ft(e)?e.call(t,n,i,r):wt(e)&&~e.indexOf("random(")?ws(e):e},Qd=Tc+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",ef={};Kt(Qd+",id,stagger,delay,duration,paused,scrollTrigger",function(s){return ef[s]=1});var yt=function(s){xd(e,s);function e(n,i,r,o){var a;typeof i=="number"&&(r.duration=i,i=r,r=null),a=s.call(this,o?i:xs(i))||this;var l=a.vars,c=l.duration,u=l.delay,h=l.immediateRender,d=l.stagger,f=l.overwrite,_=l.keyframes,m=l.defaults,g=l.scrollTrigger,p=l.yoyoEase,y=i.parent||at,x=(Bt(n)||vd(n)?ti(n[0]):"length"in i)?[n]:gn(n),v,w,T,E,C,S,b,L;if(a._targets=x.length?Ec(x):bs("GSAP target "+n+" not found. https://gsap.com",!an.nullTargetWarn)||[],a._ptLookup=[],a._overwrite=f,_||d||go(c)||go(u)){if(i=a.vars,v=a.timeline=new Gt({data:"nested",defaults:m||{},targets:y&&y.data==="nested"?y.vars.targets:x}),v.kill(),v.parent=v._dp=Kn(a),v._start=0,d||go(c)||go(u)){if(E=x.length,b=d&&Bd(d),Un(d))for(C in d)~Qd.indexOf(C)&&(L||(L={}),L[C]=d[C]);for(w=0;w<E;w++)T=Fo(i,ef),T.stagger=0,p&&(T.yoyoEase=p),L&&Zi(T,L),S=x[w],T.duration=+vs(c,Kn(a),w,S,x),T.delay=(+vs(u,Kn(a),w,S,x)||0)-a._delay,!d&&E===1&&T.delay&&(a._delay=u=T.delay,a._start+=u,T.delay=0),v.to(S,T,b?b(w,S,x):0),v._ease=Ge.none;v.duration()?c=u=0:a.timeline=0}else if(_){xs(_n(v.vars.defaults,{ease:"none"})),v._ease=Xi(_.ease||i.ease||"none");var B=0,U,K,q;if(Bt(_))_.forEach(function(H){return v.to(x,H,">")}),v.duration();else{T={};for(C in _)C==="ease"||C==="easeEach"||cv(C,_[C],T,_.easeEach);for(C in T)for(U=T[C].sort(function(H,W){return H.t-W.t}),B=0,w=0;w<U.length;w++)K=U[w],q={ease:K.e,duration:(K.t-(w?U[w-1].t:0))/100*c},q[C]=K.v,v.to(x,q,B),B+=q.duration;v.duration()<c&&v.to({},{duration:c-v.duration()})}}c||a.duration(c=v.duration())}else a.timeline=0;return f===!0&&!_c&&(xi=Kn(a),at.killTweensOf(x),xi=0),Ln(y,Kn(a),r),i.reversed&&a.reverse(),i.paused&&a.paused(!0),(h||!c&&!_&&a._start===bt(y._time)&&Yt(h)&&zy(Kn(a))&&y.data!=="nested")&&(a._tTime=-tt,a.render(Math.max(0,-u)||0)),g&&Nd(Kn(a),g),a}var t=e.prototype;return t.render=function(i,r,o){var a=this._time,l=this._tDur,c=this._dur,u=i<0,h=i>l-tt&&!u?l:i<tt?0:i,d,f,_,m,g,p,y,x,v;if(!c)Vy(this,i,r,o);else if(h!==this._tTime||!i||o||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==u){if(d=h,x=this.timeline,this._repeat){if(m=c+this._rDelay,this._repeat<-1&&u)return this.totalTime(m*100+i,r,o);if(d=bt(h%m),h===l?(_=this._repeat,d=c):(_=~~(h/m),_&&_===bt(h/m)&&(d=c,_--),d>c&&(d=c)),p=this._yoyo&&_&1,p&&(v=this._yEase,d=c-d),g=jr(this._tTime,m),d===a&&!o&&this._initted&&_===g)return this._tTime=h,this;_!==g&&(x&&this._yEase&&qd(x,p),this.vars.repeatRefresh&&!p&&!this._lock&&this._time!==m&&this._initted&&(this._lock=o=1,this.render(bt(m*_),!0).invalidate()._lock=0))}if(!this._initted){if(Ud(this,u?i:d,o,r,h))return this._tTime=0,this;if(a!==this._time&&!(o&&this.vars.repeatRefresh&&_!==g))return this;if(c!==this._dur)return this.render(i,r,o)}if(this._tTime=h,this._time=d,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=y=(v||this._ease)(d/c),this._from&&(this.ratio=y=1-y),d&&!a&&!r&&!_&&(on(this,"onStart"),this._tTime!==h))return this;for(f=this._pt;f;)f.r(y,f.d),f=f._next;x&&x.render(i<0?i:x._dur*x._ease(d/this._dur),r,o)||this._startAt&&(this._zTime=i),this._onUpdate&&!r&&(u&&Il(this,i,r,o),on(this,"onUpdate")),this._repeat&&_!==g&&this.vars.onRepeat&&!r&&this.parent&&on(this,"onRepeat"),(h===this._tDur||!h)&&this._tTime===h&&(u&&!this._onUpdate&&Il(this,i,!0,!0),(i||!c)&&(h===this._tDur&&this._ts>0||!h&&this._ts<0)&&bi(this,1),!r&&!(u&&!a)&&(h||a||p)&&(on(this,h===l?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom()))}return this},t.targets=function(){return this._targets},t.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),s.prototype.invalidate.call(this,i)},t.resetTo=function(i,r,o,a,l){Rs||sn.wake(),this._ts||this.play();var c=Math.min(this._dur,(this._dp._time-this._start)*this._ts),u;return this._initted||Ac(this,c),u=this._ease(c/this._dur),av(this,i,r,o,a,u,c,l)?this.resetTo(i,r,o,a,1):(Ko(this,0),this.parent||Id(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},t.kill=function(i,r){if(r===void 0&&(r="all"),!i&&(!r||r==="all"))return this._lazy=this._pt=0,this.parent?fs(this):this;if(this.timeline){var o=this.timeline.totalDuration();return this.timeline.killTweensOf(i,r,xi&&xi.vars.overwrite!==!0)._first||fs(this),this.parent&&o!==this.timeline.totalDuration()&&Wr(this,this._dur*this.timeline._tDur/o,0,1),this}var a=this._targets,l=i?gn(i):a,c=this._ptLookup,u=this._pt,h,d,f,_,m,g,p;if((!r||r==="all")&&By(a,l))return r==="all"&&(this._pt=0),fs(this);for(h=this._op=this._op||[],r!=="all"&&(wt(r)&&(m={},Kt(r,function(y){return m[y]=1}),r=m),r=lv(a,r)),p=a.length;p--;)if(~l.indexOf(a[p])){d=c[p],r==="all"?(h[p]=r,_=d,f={}):(f=h[p]=h[p]||{},_=r);for(m in _)g=d&&d[m],g&&((!("kill"in g.d)||g.d.kill(m)===!0)&&Xo(this,g,"_pt"),delete d[m]),f!=="all"&&(f[m]=1)}return this._initted&&!this._pt&&u&&fs(this),this},e.to=function(i,r){return new e(i,r,arguments[2])},e.from=function(i,r){return ys(1,arguments)},e.delayedCall=function(i,r,o,a){return new e(r,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:r,onReverseComplete:r,onCompleteParams:o,onReverseCompleteParams:o,callbackScope:a})},e.fromTo=function(i,r,o){return ys(2,arguments)},e.set=function(i,r){return r.duration=0,r.repeatDelay||(r.repeat=0),new e(i,r)},e.killTweensOf=function(i,r,o){return at.killTweensOf(i,r,o)},e}(Cs);_n(yt.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});Kt("staggerTo,staggerFrom,staggerFromTo",function(s){yt[s]=function(){var e=new Gt,t=Nl.call(arguments,0);return t.splice(s==="staggerFromTo"?5:4,0,0),e[s].apply(e,t)}});var wc=function(e,t,n){return e[t]=n},tf=function(e,t,n){return e[t](n)},uv=function(e,t,n,i){return e[t](i.fp,n)},hv=function(e,t,n){return e.setAttribute(t,n)},Rc=function(e,t){return ft(e[t])?tf:xc(e[t])&&e.setAttribute?hv:wc},nf=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},dv=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},rf=function(e,t){var n=t._pt,i="";if(!e&&t.b)i=t.b;else if(e===1&&t.e)i=t.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+i,n=n._next;i+=t.c}t.set(t.t,t.p,i,t)},Cc=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},fv=function(e,t,n,i){for(var r=this._pt,o;r;)o=r._next,r.p===i&&r.modifier(e,t,n),r=o},pv=function(e){for(var t=this._pt,n,i;t;)i=t._next,t.p===e&&!t.op||t.op===e?Xo(this,t,"_pt"):t.dep||(n=1),t=i;return!n},mv=function(e,t,n,i){i.mSet(e,t,i.m.call(i.tween,n,i.mt),i)},sf=function(e){for(var t=e._pt,n,i,r,o;t;){for(n=t._next,i=r;i&&i.pr>t.pr;)i=i._next;(t._prev=i?i._prev:o)?t._prev._next=t:r=t,(t._next=i)?i._prev=t:o=t,t=n}e._pt=r},qt=function(){function s(t,n,i,r,o,a,l,c,u){this.t=n,this.s=r,this.c=o,this.p=i,this.r=a||nf,this.d=l||this,this.set=c||wc,this.pr=u||0,this._next=t,t&&(t._prev=this)}var e=s.prototype;return e.modifier=function(n,i,r){this.mSet=this.mSet||this.set,this.set=mv,this.m=n,this.mt=r,this.tween=i},s}();Kt(Tc+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(s){return Sc[s]=1});ln.TweenMax=ln.TweenLite=yt;ln.TimelineLite=ln.TimelineMax=Gt;at=new Gt({sortChildren:!1,defaults:Gr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});an.stringFilter=Yd;var Yi=[],Ao={},gv=[],Sh=0,_v=0,ka=function(e){return(Ao[e]||gv).map(function(t){return t()})},Bl=function(){var e=Date.now(),t=[];e-Sh>2&&(ka("matchMediaInit"),Yi.forEach(function(n){var i=n.queries,r=n.conditions,o,a,l,c;for(a in i)o=wn.matchMedia(i[a]).matches,o&&(l=1),o!==r[a]&&(r[a]=o,c=1);c&&(n.revert(),l&&t.push(n))}),ka("matchMediaRevert"),t.forEach(function(n){return n.onMatch(n,function(i){return n.add(null,i)})}),Sh=e,ka("matchMedia"))},of=function(){function s(t,n){this.selector=n&&Ul(n),this.data=[],this._r=[],this.isReverted=!1,this.id=_v++,t&&this.add(t)}var e=s.prototype;return e.add=function(n,i,r){ft(n)&&(r=i,i=n,n=ft);var o=this,a=function(){var c=st,u=o.selector,h;return c&&c!==o&&c.data.push(o),r&&(o.selector=Ul(r)),st=o,h=i.apply(o,arguments),ft(h)&&o._r.push(h),st=c,o.selector=u,o.isReverted=!1,h};return o.last=a,n===ft?a(o,function(l){return o.add(null,l)}):n?o[n]=a:a},e.ignore=function(n){var i=st;st=null,n(this),st=i},e.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof s?n.push.apply(n,i.getTweens()):i instanceof yt&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},e.clear=function(){this._r.length=this.data.length=0},e.kill=function(n,i){var r=this;if(n?function(){for(var a=r.getTweens(),l=r.data.length,c;l--;)c=r.data[l],c.data==="isFlip"&&(c.revert(),c.getChildren(!0,!0,!1).forEach(function(u){return a.splice(a.indexOf(u),1)}));for(a.map(function(u){return{g:u._dur||u._delay||u._sat&&!u._sat.vars.immediateRender?u.globalTime(0):-1/0,t:u}}).sort(function(u,h){return h.g-u.g||-1/0}).forEach(function(u){return u.t.revert(n)}),l=r.data.length;l--;)c=r.data[l],c instanceof Gt?c.data!=="nested"&&(c.scrollTrigger&&c.scrollTrigger.revert(),c.kill()):!(c instanceof yt)&&c.revert&&c.revert(n);r._r.forEach(function(u){return u(n,r)}),r.isReverted=!0}():this.data.forEach(function(a){return a.kill&&a.kill()}),this.clear(),i)for(var o=Yi.length;o--;)Yi[o].id===this.id&&Yi.splice(o,1)},e.revert=function(n){this.kill(n||{})},s}(),xv=function(){function s(t){this.contexts=[],this.scope=t,st&&st.data.push(this)}var e=s.prototype;return e.add=function(n,i,r){Un(n)||(n={matches:n});var o=new of(0,r||this.scope),a=o.conditions={},l,c,u;st&&!o.selector&&(o.selector=st.selector),this.contexts.push(o),i=o.add("onMatch",i),o.queries=n;for(c in n)c==="all"?u=1:(l=wn.matchMedia(n[c]),l&&(Yi.indexOf(o)<0&&Yi.push(o),(a[c]=l.matches)&&(u=1),l.addListener?l.addListener(Bl):l.addEventListener("change",Bl)));return u&&i(o,function(h){return o.add(null,h)}),this},e.revert=function(n){this.kill(n||{})},e.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},s}(),ko={registerPlugin:function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];t.forEach(function(i){return jd(i)})},timeline:function(e){return new Gt(e)},getTweensOf:function(e,t){return at.getTweensOf(e,t)},getProperty:function(e,t,n,i){wt(e)&&(e=gn(e)[0]);var r=ji(e||{}).get,o=n?Ld:Pd;return n==="native"&&(n=""),e&&(t?o((nn[t]&&nn[t].get||r)(e,t,n,i)):function(a,l,c){return o((nn[a]&&nn[a].get||r)(e,a,l,c))})},quickSetter:function(e,t,n){if(e=gn(e),e.length>1){var i=e.map(function(u){return $t.quickSetter(u,t,n)}),r=i.length;return function(u){for(var h=r;h--;)i[h](u)}}e=e[0]||{};var o=nn[t],a=ji(e),l=a.harness&&(a.harness.aliases||{})[t]||t,c=o?function(u){var h=new o;Er._pt=0,h.init(e,n?u+n:u,Er,0,[e]),h.render(1,h),Er._pt&&Cc(1,Er)}:a.set(e,l);return o?c:function(u){return c(e,l,n?u+n:u,a,1)}},quickTo:function(e,t,n){var i,r=$t.to(e,Zi((i={},i[t]="+=0.1",i.paused=!0,i),n||{})),o=function(l,c,u){return r.resetTo(t,l,c,u)};return o.tween=r,o},isTweening:function(e){return at.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=Xi(e.ease,Gr.ease)),_h(Gr,e||{})},config:function(e){return _h(an,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,i=e.plugins,r=e.defaults,o=e.extendTimeline;(i||"").split(",").forEach(function(a){return a&&!nn[a]&&!ln[a]&&bs(t+" effect requires "+a+" plugin.")}),Ua[t]=function(a,l,c){return n(gn(a),_n(l||{},r),c)},o&&(Gt.prototype[t]=function(a,l,c){return this.add(Ua[t](a,Un(l)?l:(c=l)&&{},this),c)})},registerEase:function(e,t){Ge[e]=Xi(t)},parseEase:function(e,t){return arguments.length?Xi(e,t):Ge},getById:function(e){return at.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new Gt(e),i,r;for(n.smoothChildTiming=Yt(e.smoothChildTiming),at.remove(n),n._dp=0,n._time=n._tTime=at._time,i=at._first;i;)r=i._next,(t||!(!i._dur&&i instanceof yt&&i.vars.onComplete===i._targets[0]))&&Ln(n,i,i._start-i._delay),i=r;return Ln(at,n,0),n},context:function(e,t){return e?new of(e,t):st},matchMedia:function(e){return new xv(e)},matchMediaRefresh:function(){return Yi.forEach(function(e){var t=e.conditions,n,i;for(i in t)t[i]&&(t[i]=!1,n=1);n&&e.revert()})||Bl()},addEventListener:function(e,t){var n=Ao[e]||(Ao[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=Ao[e],i=n&&n.indexOf(t);i>=0&&n.splice(i,1)},utils:{wrap:Zy,wrapYoyo:$y,distribute:Bd,random:zd,snap:kd,normalize:qy,getUnit:Ut,clamp:Wy,splitColor:Wd,toArray:gn,selector:Ul,mapRange:Vd,pipe:Yy,unitize:Ky,interpolate:Jy,shuffle:Fd},install:bd,effects:Ua,ticker:sn,updateRoot:Gt.updateRoot,plugins:nn,globalTimeline:at,core:{PropTween:qt,globals:Ad,Tween:yt,Timeline:Gt,Animation:Cs,getCache:ji,_removeLinkedListItem:Xo,reverting:function(){return Ft},context:function(e){return e&&st&&(st.data.push(e),e._ctx=st),st},suppressOverwrites:function(e){return _c=e}}};Kt("to,from,fromTo,delayedCall,set,killTweensOf",function(s){return ko[s]=yt[s]});sn.add(Gt.updateRoot);Er=ko.to({},{duration:0});var yv=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},vv=function(e,t){var n=e._targets,i,r,o;for(i in t)for(r=n.length;r--;)o=e._ptLookup[r][i],o&&(o=o.d)&&(o._pt&&(o=yv(o,i)),o&&o.modifier&&o.modifier(t[i],e,n[r],i))},za=function(e,t){return{name:e,rawVars:1,init:function(i,r,o){o._onInit=function(a){var l,c;if(wt(r)&&(l={},Kt(r,function(u){return l[u]=1}),r=l),t){l={};for(c in r)l[c]=t(r[c]);r=l}vv(a,r)}}}},$t=ko.registerPlugin({name:"attr",init:function(e,t,n,i,r){var o,a,l;this.tween=n;for(o in t)l=e.getAttribute(o)||"",a=this.add(e,"setAttribute",(l||0)+"",t[o],i,r,0,0,o),a.op=o,a.b=l,this._props.push(o)},render:function(e,t){for(var n=t._pt;n;)Ft?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:"endArray",init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},za("roundProps",Ol),za("modifiers"),za("snap",kd))||ko;yt.version=Gt.version=$t.version="3.12.5";Ed=1;yc()&&Xr();Ge.Power0;Ge.Power1;Ge.Power2;Ge.Power3;Ge.Power4;Ge.Linear;Ge.Quad;Ge.Cubic;Ge.Quart;Ge.Quint;Ge.Strong;Ge.Elastic;Ge.Back;Ge.SteppedEase;Ge.Bounce;Ge.Sine;Ge.Expo;Ge.Circ;/*!
 * CSSPlugin 3.12.5
 * https://gsap.com
 *
 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var Th,yi,Lr,Pc,Gi,Eh,Lc,Mv=function(){return typeof window<"u"},ni={},ki=180/Math.PI,Ir=Math.PI/180,Mr=Math.atan2,bh=1e8,Ic=/([A-Z])/g,Sv=/(left|right|width|margin|padding|x)/i,Tv=/[\s,\(]\S/,In={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},kl=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Ev=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},bv=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},Av=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},af=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},lf=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},wv=function(e,t,n){return e.style[t]=n},Rv=function(e,t,n){return e.style.setProperty(t,n)},Cv=function(e,t,n){return e._gsap[t]=n},Pv=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},Lv=function(e,t,n,i,r){var o=e._gsap;o.scaleX=o.scaleY=n,o.renderTransform(r,o)},Iv=function(e,t,n,i,r){var o=e._gsap;o[t]=n,o.renderTransform(r,o)},lt="transform",Zt=lt+"Origin",Dv=function s(e,t){var n=this,i=this.target,r=i.style,o=i._gsap;if(e in ni&&r){if(this.tfm=this.tfm||{},e!=="transform")e=In[e]||e,~e.indexOf(",")?e.split(",").forEach(function(a){return n.tfm[a]=qn(i,a)}):this.tfm[e]=o.x?o[e]:qn(i,e),e===Zt&&(this.tfm.zOrigin=o.zOrigin);else return In.transform.split(",").forEach(function(a){return s.call(n,a,t)});if(this.props.indexOf(lt)>=0)return;o.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Zt,t,"")),e=lt}(r||t)&&this.props.push(e,t,r[e])},cf=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},Nv=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,r,o;for(r=0;r<e.length;r+=3)e[r+1]?t[e[r]]=e[r+2]:e[r+2]?n[e[r]]=e[r+2]:n.removeProperty(e[r].substr(0,2)==="--"?e[r]:e[r].replace(Ic,"-$1").toLowerCase());if(this.tfm){for(o in this.tfm)i[o]=this.tfm[o];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),r=Lc(),(!r||!r.isStart)&&!n[lt]&&(cf(n),i.zOrigin&&n[Zt]&&(n[Zt]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},uf=function(e,t){var n={target:e,props:[],revert:Nv,save:Dv};return e._gsap||$t.core.getCache(e),t&&t.split(",").forEach(function(i){return n.save(i)}),n},hf,zl=function(e,t){var n=yi.createElementNS?yi.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):yi.createElement(e);return n&&n.style?n:yi.createElement(e)},Dn=function s(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(Ic,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&s(e,Yr(t)||t,1)||""},Ah="O,Moz,ms,Ms,Webkit".split(","),Yr=function(e,t,n){var i=t||Gi,r=i.style,o=5;if(e in r&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);o--&&!(Ah[o]+e in r););return o<0?null:(o===3?"ms":o>=0?Ah[o]:"")+e},Hl=function(){Mv()&&window.document&&(Th=window,yi=Th.document,Lr=yi.documentElement,Gi=zl("div")||{style:{}},zl("div"),lt=Yr(lt),Zt=lt+"Origin",Gi.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",hf=!!Yr("perspective"),Lc=$t.core.reverting,Pc=1)},Ha=function s(e){var t=zl("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,r=this.style.cssText,o;if(Lr.appendChild(t),t.appendChild(this),this.style.display="block",e)try{o=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=s}catch{}else this._gsapBBox&&(o=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),Lr.removeChild(t),this.style.cssText=r,o},wh=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},df=function(e){var t;try{t=e.getBBox()}catch{t=Ha.call(e,!0)}return t&&(t.width||t.height)||e.getBBox===Ha||(t=Ha.call(e,!0)),t&&!t.width&&!t.x&&!t.y?{x:+wh(e,["x","cx","x1"])||0,y:+wh(e,["y","cy","y1"])||0,width:0,height:0}:t},ff=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&df(e))},$i=function(e,t){if(t){var n=e.style,i;t in ni&&t!==Zt&&(t=lt),n.removeProperty?(i=t.substr(0,2),(i==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(i==="--"?t:t.replace(Ic,"-$1").toLowerCase())):n.removeAttribute(t)}},vi=function(e,t,n,i,r,o){var a=new qt(e._pt,t,n,0,1,o?lf:af);return e._pt=a,a.b=i,a.e=r,e._props.push(n),a},Rh={deg:1,rad:1,turn:1},Uv={grid:1,flex:1},Ai=function s(e,t,n,i){var r=parseFloat(n)||0,o=(n+"").trim().substr((r+"").length)||"px",a=Gi.style,l=Sv.test(t),c=e.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,d=i==="px",f=i==="%",_,m,g,p;if(i===o||!r||Rh[i]||Rh[o])return r;if(o!=="px"&&!d&&(r=s(e,t,n,"px")),p=e.getCTM&&ff(e),(f||o==="%")&&(ni[t]||~t.indexOf("adius")))return _=p?e.getBBox()[l?"width":"height"]:e[u],mt(f?r/_*h:r/100*_);if(a[l?"width":"height"]=h+(d?o:i),m=~t.indexOf("adius")||i==="em"&&e.appendChild&&!c?e:e.parentNode,p&&(m=(e.ownerSVGElement||{}).parentNode),(!m||m===yi||!m.appendChild)&&(m=yi.body),g=m._gsap,g&&f&&g.width&&l&&g.time===sn.time&&!g.uncache)return mt(r/g.width*h);if(f&&(t==="height"||t==="width")){var y=e.style[t];e.style[t]=h+i,_=e[u],y?e.style[t]=y:$i(e,t)}else(f||o==="%")&&!Uv[Dn(m,"display")]&&(a.position=Dn(e,"position")),m===e&&(a.position="static"),m.appendChild(Gi),_=Gi[u],m.removeChild(Gi),a.position="absolute";return l&&f&&(g=ji(m),g.time=sn.time,g.width=m[u]),mt(d?_*r/h:_&&r?h/_*r:0)},qn=function(e,t,n,i){var r;return Pc||Hl(),t in In&&t!=="transform"&&(t=In[t],~t.indexOf(",")&&(t=t.split(",")[0])),ni[t]&&t!=="transform"?(r=Ls(e,i),r=t!=="transformOrigin"?r[t]:r.svg?r.origin:Ho(Dn(e,Zt))+" "+r.zOrigin+"px"):(r=e.style[t],(!r||r==="auto"||i||~(r+"").indexOf("calc("))&&(r=zo[t]&&zo[t](e,t,n)||Dn(e,t)||Rd(e,t)||(t==="opacity"?1:0))),n&&!~(r+"").trim().indexOf(" ")?Ai(e,t,r,n)+n:r},Ov=function(e,t,n,i){if(!n||n==="none"){var r=Yr(t,e,1),o=r&&Dn(e,r,1);o&&o!==n?(t=r,n=o):t==="borderColor"&&(n=Dn(e,"borderTopColor"))}var a=new qt(this._pt,e.style,t,0,1,rf),l=0,c=0,u,h,d,f,_,m,g,p,y,x,v,w;if(a.b=n,a.e=i,n+="",i+="",i==="auto"&&(m=e.style[t],e.style[t]=i,i=Dn(e,t)||i,m?e.style[t]=m:$i(e,t)),u=[n,i],Yd(u),n=u[0],i=u[1],d=n.match(Tr)||[],w=i.match(Tr)||[],w.length){for(;h=Tr.exec(i);)g=h[0],y=i.substring(l,h.index),_?_=(_+1)%5:(y.substr(-5)==="rgba("||y.substr(-5)==="hsla(")&&(_=1),g!==(m=d[c++]||"")&&(f=parseFloat(m)||0,v=m.substr((f+"").length),g.charAt(1)==="="&&(g=Pr(f,g)+v),p=parseFloat(g),x=g.substr((p+"").length),l=Tr.lastIndex-x.length,x||(x=x||an.units[t]||v,l===i.length&&(i+=x,a.e+=x)),v!==x&&(f=Ai(e,t,m,x)||0),a._pt={_next:a._pt,p:y||c===1?y:",",s:f,c:p-f,m:_&&_<4||t==="zIndex"?Math.round:0});a.c=l<i.length?i.substring(l,i.length):""}else a.r=t==="display"&&i==="none"?lf:af;return Sd.test(i)&&(a.e=0),this._pt=a,a},Ch={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},Fv=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=Ch[n]||n,t[1]=Ch[i]||i,t.join(" ")},Bv=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,r=t.u,o=n._gsap,a,l,c;if(r==="all"||r===!0)i.cssText="",l=1;else for(r=r.split(","),c=r.length;--c>-1;)a=r[c],ni[a]&&(l=1,a=a==="transformOrigin"?Zt:lt),$i(n,a);l&&($i(n,lt),o&&(o.svg&&n.removeAttribute("transform"),Ls(n,1),o.uncache=1,cf(i)))}},zo={clearProps:function(e,t,n,i,r){if(r.data!=="isFromStart"){var o=e._pt=new qt(e._pt,t,n,0,0,Bv);return o.u=i,o.pr=-10,o.tween=r,e._props.push(n),1}}},Ps=[1,0,0,1,0,0],pf={},mf=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},Ph=function(e){var t=Dn(e,lt);return mf(t)?Ps:t.substr(7).match(Md).map(mt)},Dc=function(e,t){var n=e._gsap||ji(e),i=e.style,r=Ph(e),o,a,l,c;return n.svg&&e.getAttribute("transform")?(l=e.transform.baseVal.consolidate().matrix,r=[l.a,l.b,l.c,l.d,l.e,l.f],r.join(",")==="1,0,0,1,0,0"?Ps:r):(r===Ps&&!e.offsetParent&&e!==Lr&&!n.svg&&(l=i.display,i.display="block",o=e.parentNode,(!o||!e.offsetParent)&&(c=1,a=e.nextElementSibling,Lr.appendChild(e)),r=Ph(e),l?i.display=l:$i(e,"display"),c&&(a?o.insertBefore(e,a):o?o.appendChild(e):Lr.removeChild(e))),t&&r.length>6?[r[0],r[1],r[4],r[5],r[12],r[13]]:r)},Vl=function(e,t,n,i,r,o){var a=e._gsap,l=r||Dc(e,!0),c=a.xOrigin||0,u=a.yOrigin||0,h=a.xOffset||0,d=a.yOffset||0,f=l[0],_=l[1],m=l[2],g=l[3],p=l[4],y=l[5],x=t.split(" "),v=parseFloat(x[0])||0,w=parseFloat(x[1])||0,T,E,C,S;n?l!==Ps&&(E=f*g-_*m)&&(C=v*(g/E)+w*(-m/E)+(m*y-g*p)/E,S=v*(-_/E)+w*(f/E)-(f*y-_*p)/E,v=C,w=S):(T=df(e),v=T.x+(~x[0].indexOf("%")?v/100*T.width:v),w=T.y+(~(x[1]||x[0]).indexOf("%")?w/100*T.height:w)),i||i!==!1&&a.smooth?(p=v-c,y=w-u,a.xOffset=h+(p*f+y*m)-p,a.yOffset=d+(p*_+y*g)-y):a.xOffset=a.yOffset=0,a.xOrigin=v,a.yOrigin=w,a.smooth=!!i,a.origin=t,a.originIsAbsolute=!!n,e.style[Zt]="0px 0px",o&&(vi(o,a,"xOrigin",c,v),vi(o,a,"yOrigin",u,w),vi(o,a,"xOffset",h,a.xOffset),vi(o,a,"yOffset",d,a.yOffset)),e.setAttribute("data-svg-origin",v+" "+w)},Ls=function(e,t){var n=e._gsap||new $d(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,r=n.scaleX<0,o="px",a="deg",l=getComputedStyle(e),c=Dn(e,Zt)||"0",u,h,d,f,_,m,g,p,y,x,v,w,T,E,C,S,b,L,B,U,K,q,H,W,G,ne,re,ae,Me,ke,X,$;return u=h=d=m=g=p=y=x=v=0,f=_=1,n.svg=!!(e.getCTM&&ff(e)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[lt]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[lt]!=="none"?l[lt]:"")),i.scale=i.rotate=i.translate="none"),E=Dc(e,n.svg),n.svg&&(n.uncache?(G=e.getBBox(),c=n.xOrigin-G.x+"px "+(n.yOrigin-G.y)+"px",W=""):W=!t&&e.getAttribute("data-svg-origin"),Vl(e,W||c,!!W||n.originIsAbsolute,n.smooth!==!1,E)),w=n.xOrigin||0,T=n.yOrigin||0,E!==Ps&&(L=E[0],B=E[1],U=E[2],K=E[3],u=q=E[4],h=H=E[5],E.length===6?(f=Math.sqrt(L*L+B*B),_=Math.sqrt(K*K+U*U),m=L||B?Mr(B,L)*ki:0,y=U||K?Mr(U,K)*ki+m:0,y&&(_*=Math.abs(Math.cos(y*Ir))),n.svg&&(u-=w-(w*L+T*U),h-=T-(w*B+T*K))):($=E[6],ke=E[7],re=E[8],ae=E[9],Me=E[10],X=E[11],u=E[12],h=E[13],d=E[14],C=Mr($,Me),g=C*ki,C&&(S=Math.cos(-C),b=Math.sin(-C),W=q*S+re*b,G=H*S+ae*b,ne=$*S+Me*b,re=q*-b+re*S,ae=H*-b+ae*S,Me=$*-b+Me*S,X=ke*-b+X*S,q=W,H=G,$=ne),C=Mr(-U,Me),p=C*ki,C&&(S=Math.cos(-C),b=Math.sin(-C),W=L*S-re*b,G=B*S-ae*b,ne=U*S-Me*b,X=K*b+X*S,L=W,B=G,U=ne),C=Mr(B,L),m=C*ki,C&&(S=Math.cos(C),b=Math.sin(C),W=L*S+B*b,G=q*S+H*b,B=B*S-L*b,H=H*S-q*b,L=W,q=G),g&&Math.abs(g)+Math.abs(m)>359.9&&(g=m=0,p=180-p),f=mt(Math.sqrt(L*L+B*B+U*U)),_=mt(Math.sqrt(H*H+$*$)),C=Mr(q,H),y=Math.abs(C)>2e-4?C*ki:0,v=X?1/(X<0?-X:X):0),n.svg&&(W=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!mf(Dn(e,lt)),W&&e.setAttribute("transform",W))),Math.abs(y)>90&&Math.abs(y)<270&&(r?(f*=-1,y+=m<=0?180:-180,m+=m<=0?180:-180):(_*=-1,y+=y<=0?180:-180)),t=t||n.uncache,n.x=u-((n.xPercent=u&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-u)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+o,n.y=h-((n.yPercent=h&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-h)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+o,n.z=d+o,n.scaleX=mt(f),n.scaleY=mt(_),n.rotation=mt(m)+a,n.rotationX=mt(g)+a,n.rotationY=mt(p)+a,n.skewX=y+a,n.skewY=x+a,n.transformPerspective=v+o,(n.zOrigin=parseFloat(c.split(" ")[2])||!t&&n.zOrigin||0)&&(i[Zt]=Ho(c)),n.xOffset=n.yOffset=0,n.force3D=an.force3D,n.renderTransform=n.svg?zv:hf?gf:kv,n.uncache=0,n},Ho=function(e){return(e=e.split(" "))[0]+" "+e[1]},Va=function(e,t,n){var i=Ut(t);return mt(parseFloat(t)+parseFloat(Ai(e,"x",n+"px",i)))+i},kv=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,gf(e,t)},Oi="0deg",us="0px",Fi=") ",gf=function(e,t){var n=t||this,i=n.xPercent,r=n.yPercent,o=n.x,a=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,d=n.skewX,f=n.skewY,_=n.scaleX,m=n.scaleY,g=n.transformPerspective,p=n.force3D,y=n.target,x=n.zOrigin,v="",w=p==="auto"&&e&&e!==1||p===!0;if(x&&(h!==Oi||u!==Oi)){var T=parseFloat(u)*Ir,E=Math.sin(T),C=Math.cos(T),S;T=parseFloat(h)*Ir,S=Math.cos(T),o=Va(y,o,E*S*-x),a=Va(y,a,-Math.sin(T)*-x),l=Va(y,l,C*S*-x+x)}g!==us&&(v+="perspective("+g+Fi),(i||r)&&(v+="translate("+i+"%, "+r+"%) "),(w||o!==us||a!==us||l!==us)&&(v+=l!==us||w?"translate3d("+o+", "+a+", "+l+") ":"translate("+o+", "+a+Fi),c!==Oi&&(v+="rotate("+c+Fi),u!==Oi&&(v+="rotateY("+u+Fi),h!==Oi&&(v+="rotateX("+h+Fi),(d!==Oi||f!==Oi)&&(v+="skew("+d+", "+f+Fi),(_!==1||m!==1)&&(v+="scale("+_+", "+m+Fi),y.style[lt]=v||"translate(0, 0)"},zv=function(e,t){var n=t||this,i=n.xPercent,r=n.yPercent,o=n.x,a=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,d=n.scaleY,f=n.target,_=n.xOrigin,m=n.yOrigin,g=n.xOffset,p=n.yOffset,y=n.forceCSS,x=parseFloat(o),v=parseFloat(a),w,T,E,C,S;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=Ir,c*=Ir,w=Math.cos(l)*h,T=Math.sin(l)*h,E=Math.sin(l-c)*-d,C=Math.cos(l-c)*d,c&&(u*=Ir,S=Math.tan(c-u),S=Math.sqrt(1+S*S),E*=S,C*=S,u&&(S=Math.tan(u),S=Math.sqrt(1+S*S),w*=S,T*=S)),w=mt(w),T=mt(T),E=mt(E),C=mt(C)):(w=h,C=d,T=E=0),(x&&!~(o+"").indexOf("px")||v&&!~(a+"").indexOf("px"))&&(x=Ai(f,"x",o,"px"),v=Ai(f,"y",a,"px")),(_||m||g||p)&&(x=mt(x+_-(_*w+m*E)+g),v=mt(v+m-(_*T+m*C)+p)),(i||r)&&(S=f.getBBox(),x=mt(x+i/100*S.width),v=mt(v+r/100*S.height)),S="matrix("+w+","+T+","+E+","+C+","+x+","+v+")",f.setAttribute("transform",S),y&&(f.style[lt]=S)},Hv=function(e,t,n,i,r){var o=360,a=wt(r),l=parseFloat(r)*(a&&~r.indexOf("rad")?ki:1),c=l-i,u=i+c+"deg",h,d;return a&&(h=r.split("_")[1],h==="short"&&(c%=o,c!==c%(o/2)&&(c+=c<0?o:-o)),h==="cw"&&c<0?c=(c+o*bh)%o-~~(c/o)*o:h==="ccw"&&c>0&&(c=(c-o*bh)%o-~~(c/o)*o)),e._pt=d=new qt(e._pt,t,n,i,c,Ev),d.e=u,d.u="deg",e._props.push(n),d},Lh=function(e,t){for(var n in t)e[n]=t[n];return e},Vv=function(e,t,n){var i=Lh({},n._gsap),r="perspective,force3D,transformOrigin,svgOrigin",o=n.style,a,l,c,u,h,d,f,_;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),o[lt]=t,a=Ls(n,1),$i(n,lt),n.setAttribute("transform",c)):(c=getComputedStyle(n)[lt],o[lt]=t,a=Ls(n,1),o[lt]=c);for(l in ni)c=i[l],u=a[l],c!==u&&r.indexOf(l)<0&&(f=Ut(c),_=Ut(u),h=f!==_?Ai(n,l,c,_):parseFloat(c),d=parseFloat(u),e._pt=new qt(e._pt,a,l,h,d-h,kl),e._pt.u=_||0,e._props.push(l));Lh(a,i)};Kt("padding,margin,Width,Radius",function(s,e){var t="Top",n="Right",i="Bottom",r="Left",o=(e<3?[t,n,i,r]:[t+r,t+n,i+n,i+r]).map(function(a){return e<2?s+a:"border"+a+s});zo[e>1?"border"+s:s]=function(a,l,c,u,h){var d,f;if(arguments.length<4)return d=o.map(function(_){return qn(a,_,c)}),f=d.join(" "),f.split(d[0]).length===5?d[0]:f;d=(u+"").split(" "),f={},o.forEach(function(_,m){return f[_]=d[m]=d[m]||d[(m-1)/2|0]}),a.init(l,f,h)}});var _f={name:"css",register:Hl,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,r){var o=this._props,a=e.style,l=n.vars.startAt,c,u,h,d,f,_,m,g,p,y,x,v,w,T,E,C;Pc||Hl(),this.styles=this.styles||uf(e),C=this.styles.props,this.tween=n;for(m in t)if(m!=="autoRound"&&(u=t[m],!(nn[m]&&Jd(m,t,n,i,e,r)))){if(f=typeof u,_=zo[m],f==="function"&&(u=u.call(n,i,e,r),f=typeof u),f==="string"&&~u.indexOf("random(")&&(u=ws(u)),_)_(this,e,m,u,n)&&(E=1);else if(m.substr(0,2)==="--")c=(getComputedStyle(e).getPropertyValue(m)+"").trim(),u+="",Ei.lastIndex=0,Ei.test(c)||(g=Ut(c),p=Ut(u)),p?g!==p&&(c=Ai(e,m,c,p)+p):g&&(u+=g),this.add(a,"setProperty",c,u,i,r,0,0,m),o.push(m),C.push(m,0,a[m]);else if(f!=="undefined"){if(l&&m in l?(c=typeof l[m]=="function"?l[m].call(n,i,e,r):l[m],wt(c)&&~c.indexOf("random(")&&(c=ws(c)),Ut(c+"")||c==="auto"||(c+=an.units[m]||Ut(qn(e,m))||""),(c+"").charAt(1)==="="&&(c=qn(e,m))):c=qn(e,m),d=parseFloat(c),y=f==="string"&&u.charAt(1)==="="&&u.substr(0,2),y&&(u=u.substr(2)),h=parseFloat(u),m in In&&(m==="autoAlpha"&&(d===1&&qn(e,"visibility")==="hidden"&&h&&(d=0),C.push("visibility",0,a.visibility),vi(this,a,"visibility",d?"inherit":"hidden",h?"inherit":"hidden",!h)),m!=="scale"&&m!=="transform"&&(m=In[m],~m.indexOf(",")&&(m=m.split(",")[0]))),x=m in ni,x){if(this.styles.save(m),v||(w=e._gsap,w.renderTransform&&!t.parseTransform||Ls(e,t.parseTransform),T=t.smoothOrigin!==!1&&w.smooth,v=this._pt=new qt(this._pt,a,lt,0,1,w.renderTransform,w,0,-1),v.dep=1),m==="scale")this._pt=new qt(this._pt,w,"scaleY",w.scaleY,(y?Pr(w.scaleY,y+h):h)-w.scaleY||0,kl),this._pt.u=0,o.push("scaleY",m),m+="X";else if(m==="transformOrigin"){C.push(Zt,0,a[Zt]),u=Fv(u),w.svg?Vl(e,u,0,T,0,this):(p=parseFloat(u.split(" ")[2])||0,p!==w.zOrigin&&vi(this,w,"zOrigin",w.zOrigin,p),vi(this,a,m,Ho(c),Ho(u)));continue}else if(m==="svgOrigin"){Vl(e,u,1,T,0,this);continue}else if(m in pf){Hv(this,w,m,d,y?Pr(d,y+u):u);continue}else if(m==="smoothOrigin"){vi(this,w,"smooth",w.smooth,u);continue}else if(m==="force3D"){w[m]=u;continue}else if(m==="transform"){Vv(this,u,e);continue}}else m in a||(m=Yr(m)||m);if(x||(h||h===0)&&(d||d===0)&&!Tv.test(u)&&m in a)g=(c+"").substr((d+"").length),h||(h=0),p=Ut(u)||(m in an.units?an.units[m]:g),g!==p&&(d=Ai(e,m,c,p)),this._pt=new qt(this._pt,x?w:a,m,d,(y?Pr(d,y+h):h)-d,!x&&(p==="px"||m==="zIndex")&&t.autoRound!==!1?Av:kl),this._pt.u=p||0,g!==p&&p!=="%"&&(this._pt.b=c,this._pt.r=bv);else if(m in a)Ov.call(this,e,m,c,y?y+u:u);else if(m in e)this.add(e,m,c||e[m],y?y+u:u,i,r);else if(m!=="parseTransform"){Mc(m,u);continue}x||(m in a?C.push(m,0,a[m]):C.push(m,1,c||e[m])),o.push(m)}}E&&sf(this)},render:function(e,t){if(t.tween._time||!Lc())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:qn,aliases:In,getSetter:function(e,t,n){var i=In[t];return i&&i.indexOf(",")<0&&(t=i),t in ni&&t!==Zt&&(e._gsap.x||qn(e,"x"))?n&&Eh===n?t==="scale"?Pv:Cv:(Eh=n||{})&&(t==="scale"?Lv:Iv):e.style&&!xc(e.style[t])?wv:~t.indexOf("-")?Rv:Rc(e,t)},core:{_removeProperty:$i,_getMatrix:Dc}};$t.utils.checkPrefix=Yr;$t.core.getStyleSaver=uf;(function(s,e,t,n){var i=Kt(s+","+e+","+t,function(r){ni[r]=1});Kt(e,function(r){an.units[r]="deg",pf[r]=1}),In[i[13]]=s+","+e,Kt(n,function(r){var o=r.split(":");In[o[1]]=i[o[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Kt("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(s){an.units[s]="px"});$t.registerPlugin(_f);var Is=$t.registerPlugin(_f)||$t;Is.core.Tween;const Gv=s=>{const e=document.querySelector("#front"),t=document.querySelector("#back"),n=document.querySelector("#left"),i=document.querySelector("#right"),r=document.querySelector("#body"),o=document.querySelector("#head");e.addEventListener("click",()=>{a(-.6314954594490563,.6306999065581489,9.286856107569474,1)}),t.addEventListener("click",()=>{a(-.5490899696241803,1.2921433022964555,-7.945298722141956,1)}),n.addEventListener("click",()=>{a(-6.910456907684895,-.3007518968785895,-.09388359602681749,1)}),i.addEventListener("click",()=>{a(9.899425237887076,-.20431908945524174,1.3998691614463707,1)}),r.addEventListener("click",()=>{a(.31616102219759334,-4.585210236552844,3.335984298295238,1)}),o.addEventListener("click",()=>{a(.30968940109422394,6.669334261965599,2.0398495711876268,1)});function a(l,c,u,h){Is.to(s.position,{x:l,y:c,z:u,duration:2,ease:"power2.inOut",onUpdate:()=>{s.updateProjectionMatrix()}}),Is.to(s,{zoom:h,duration:2,ease:"power2.inOut",onUpdate:()=>{s.updateProjectionMatrix()}})}};class jv{constructor(){Ue(this,"scene",new q_);Ue(this,"camera",Ux());Ue(this,"renderer",kx());Ue(this,"helpers",Bx(this.camera,this.renderer));Ue(this,"guitar",new wy(this.scene,this.camera));Ue(this,"uiControler",new Ry(this.guitar));Ue(this,"isLoading",!1);Ue(this,"lightPositions",[[0,0,8],[0,0,-8],[-9.947420066907123,-1.019879765564146,-.09316263352782056],[9.981306658855566,-.4765927811330809,.3825920841538427],[-.1268484876457273,-5.6404379973057175,.7229959592571308]]);Ue(this,"geometry",new uc(30,30,30));Ue(this,"material",new ei({fragmentShader:`
      #ifdef GL_ES
      precision mediump float;
      #endif
